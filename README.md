...
- backend на .NET 9: `1556/1556` unit tests;
...
- карточки рабочих сценариев локализуют server/inbound strategy и полный payment lifecycle без изменения raw API-значений, а локальный SQLite repair обновляет существующие базы с revision-колонками;
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-15-admin-scenario-lifecycle-and-local-sqlite-repair`, версия `0.732.0`;
