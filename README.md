...
- backend на .NET 9: `1211/1211` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-12-provisioning-inventory-argument-guard`, версия `0.647.0`;
