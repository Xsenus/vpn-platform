...
- backend на .NET 9: `716/716` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-07-02-changelog-test-results-top-release-guard`, версия `0.425.0`;
