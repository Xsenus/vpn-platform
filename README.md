...
- backend на .NET 9: `611/611` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-07-01-admin-vps-bootstrap-smoke-evidence-latest-release-guard`, версия `0.316.0`;
