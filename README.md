...
- backend на .NET 9: `1345/1345` unit tests;
- API Release build: без ошибок и предупреждений;
- frontend unit tests: `145/145`;
...
- backend `1345/1345`, frontend `145/145`, полный Playwright `227/227` за `12.9 min`, targeted admin payment recheck desktop/mobile `2/2`, dependency audit `0 vulnerabilities`;
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-12-admin-payment-recheck-boundary`, версия `0.665.0`;
