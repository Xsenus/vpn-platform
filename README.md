...
- backend на .NET 9: `1459/1459` unit tests;
...
- backend `1459/1459`, frontend `172/172`, subscription/access lifecycle desktop/mobile Playwright `6/6`, server mode lifecycle/conflict desktop/mobile Playwright `4/4`, provisioning lifecycle/conflict Playwright `2/2`, dependency audit `0 vulnerabilities`;
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-13-admin-subscription-access-read-boundary`, версия `0.684.0`;
