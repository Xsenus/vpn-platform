...
- backend на .NET 9: `664/664` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-07-02-production-handoff-receipt-release-guard-cleanup`, версия `0.369.0`;
