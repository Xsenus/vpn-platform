...
- backend на .NET 9: `1409/1409` unit tests;
- API Release build: без ошибок и предупреждений;
- frontend unit tests: `167/167`;
...
- backend `1409/1409`, frontend `167/167`, work scenario stale PUT/DELETE desktop/mobile Playwright `4/4`, dependency audit `0 vulnerabilities`;
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-13-work-scenario-boundary`, версия `0.678.0`;
