...
- backend на .NET 9: `1569/1569` unit tests;
...
- admin production bundle: `5` JS chunks, largest `270715`, total raw `579420/580608`, gzip `154073/154624` bytes; build budget fail-closed проверяет largest/total raw/gzip;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-15-commercial-editor-noop-integrity`, версия `0.737.0`;
