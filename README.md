...
- backend на .NET 9: `1355/1355` unit tests;
- API Release build: без ошибок и предупреждений;
- frontend unit tests: `149/149`;
...
- backend `1355/1355`, frontend `149/149`, полный Playwright `227/227` за `12.9 min`, full admin Playwright `54/54`, targeted webhook desktop/mobile `2/2`, responsive admin matrix `1/1`, dependency audit `0 vulnerabilities`;
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-12-admin-webhook-event-boundary`, версия `0.667.0`;
