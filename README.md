...
- backend на .NET 9: `569/569` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-06-19-payment-provider-smoke-report-acceptance-gates`, версия `0.180.0`;
