...
- backend на .NET 9: `630/630` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-07-01-production-handoff-package-archive-nested-entry-guard`, версия `0.335.0`;
