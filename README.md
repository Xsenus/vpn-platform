...
- backend на .NET 9: `525/525` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-06-18-production-evidence-handoff-package-validator`, версия `0.139.0`;
