...
- backend на .NET 9: `600/600` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-07-01-production-handoff-checklist-latest-release-guard`, версия `0.305.0`;
