...
- backend на .NET 9: `542/542` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-06-18-production-readiness-assertion-result-artifacts`, версия `0.156.0`;
