...
- Playwright E2E: public, cabinet, admin, all-screens, mobile и console smoke проходят `114/114`; responsive matrix проверяет 18 конфигураций `305x568..2560x1440`, включая mobile landscape и обе стороны CSS-breakpoints;
...
- desktop/mobile browser flow сохраняет VPN access status/disabledAt/revision через disable/reload/enable/sync/reset-traffic и не раскрывает terminal access secrets;
...
- admin production bundle: `5` JS chunks, largest `219849`, total raw `512438`, gzip `137533` bytes; build budget fail-closed проверяет largest/total raw/gzip;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-10-admin-invalid-hash-canonical-fallback`, версия `0.571.0`;
