...
- backend на .NET 9: `612/612` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-07-01-admin-vps-smoke-generator-release-guard`, версия `0.317.0`;
