...
- backend на .NET 9: `663/663` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-07-02-production-evidence-archive-release-guard-cleanup`, версия `0.368.0`;
