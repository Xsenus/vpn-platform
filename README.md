...
- backend на .NET 9: `1566/1566` unit tests;
- API Release build: без ошибок и предупреждений;
- frontend unit tests: `184/184`;
...
- admin production bundle: `5` JS chunks, largest `267866`, total raw `576571/577536`, gzip `153129/153600` bytes; build budget fail-closed проверяет largest/total raw/gzip;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-15-managed-editor-draft-integrity`, версия `0.736.0`;
...
- roadmap progress: `759/779` closed, readiness `97.4%`, `20` remaining, `19` open, `1` in progress and `0` blocked;
