...
- backend на .NET 9: `1358/1358` unit tests;
- API Release build: без ошибок и предупреждений;
- frontend unit tests: `152/152`;
...
- backend `1358/1358`, frontend `152/152`, полный Playwright baseline `227/227`, cabinet VPN access desktop/mobile Playwright `64/64`, dependency audit `0 vulnerabilities`;
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-12-cabinet-access-boundary`, версия `0.670.0`;
