...
- backend на .NET 9: `593/593` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-06-24-admin-vps-smoke-remote-release-console-summary`, версия `0.293.0`;
