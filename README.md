...
- backend на .NET 9: `1575/1575` unit tests;
- API Release build: без ошибок и предупреждений;
- frontend unit tests: `193/193`;
...
- admin production bundle: `5` JS chunks, largest `277063`, total raw `585800/586752`, gzip `155817/156672` bytes; build budget fail-closed проверяет largest/total raw/gzip;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-15-server-editor-noop-draft-integrity`, версия `0.741.0`;
...
- roadmap progress: `764/784` closed, readiness `97.4%`, `20` remaining, `19` open, `1` in progress and `0` blocked;
