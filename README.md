...
- Playwright E2E: public, cabinet, admin, all-screens, mobile и console smoke проходят `122/122`; responsive matrix проверяет 19 конфигураций `305x568..2560x1440`, включая mobile landscape и обе стороны CSS-breakpoints;
...
- admin production bundle: `5` JS chunks, largest `219849`, total raw `516939`, gzip `138621` bytes; build budget fail-closed проверяет largest/total raw/gzip;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-10-admin-vpn-form-validation-boundary`, версия `0.579.0`;
