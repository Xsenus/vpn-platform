...
- backend на .NET 9: `1362/1362` unit tests;
- API Release build: без ошибок и предупреждений;
- frontend unit tests: `154/154`;
...
- backend `1362/1362`, frontend `154/154`, полный Playwright baseline `227/227`, cabinet/public desktop/mobile Playwright `118/118`, dependency audit `0 vulnerabilities`;
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-12-cabinet-order-boundary`, версия `0.671.0`;
