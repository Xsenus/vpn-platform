...
- backend на .NET 9: `1356/1356` unit tests;
- API Release build: без ошибок и предупреждений;
- frontend unit tests: `150/150`;
...
- backend `1356/1356`, frontend `150/150`, полный Playwright baseline `227/227`, cabinet Playwright `32/32`, targeted cabinet payment desktop/mobile `2/2`, dependency audit `0 vulnerabilities`;
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-12-cabinet-payment-boundary`, версия `0.668.0`;
