...
- backend на .NET 9: `683/683` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-07-02-admin-vps-smoke-preflight-validator-cleanup`, версия `0.388.0`;
