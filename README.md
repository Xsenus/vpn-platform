...
- Playwright E2E: public, cabinet, admin, all-screens, mobile и console smoke проходят `66/66`; responsive matrix проверяет ширины `305..1920` px;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-09-admin-mutation-request-lifecycle`, версия `0.549.0`;
