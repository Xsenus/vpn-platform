...
- backend на .NET 9: `797/797` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-04-subscription-node-integrity-hardening`, версия `0.458.0`;
