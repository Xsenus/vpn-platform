...
- backend на .NET 9: `1354/1354` unit tests;
- API Release build: без ошибок и предупреждений;
- frontend unit tests: `148/148`;
...
- backend `1354/1354`, frontend `148/148`, полный Playwright `227/227` за `12.9 min`, targeted refund lifecycle desktop/mobile `6/6`, dependency audit `0 vulnerabilities`;
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-12-refund-create-recovery`, версия `0.666.0`;
