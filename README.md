...
- backend на .NET 9: `616/616` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-07-01-vps-production-smoke-generator-release-guard`, версия `0.321.0`;
