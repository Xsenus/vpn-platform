...
- backend на .NET 9: `672/672` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-07-02-vps-production-smoke-generator-release-guard-cleanup`, версия `0.377.0`;
