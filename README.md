...
- backend на .NET 9: `1357/1357` unit tests;
...
- backend `1357/1357`, frontend `151/151`, полный Playwright baseline `227/227`, cabinet subscription desktop/mobile Playwright `64/64`, dependency audit `0 vulnerabilities`;
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-12-cabinet-subscription-boundary`, версия `0.669.0`;
