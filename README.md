...
- Playwright E2E: public, cabinet, admin, all-screens, mobile и console smoke проходят `116/116`; responsive matrix проверяет 18 конфигураций `305x568..2560x1440`, включая mobile landscape и обе стороны CSS-breakpoints;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-10-admin-skip-link-route-preservation`, версия `0.572.0`;
