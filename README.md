...
- backend на .NET 9: `1499/1499` unit tests;
...
- roadmap progress: `730/750` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress and `0` blocked;
