...
- backend на .NET 9: `1287/1287` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-12-telegram-payment-recovery-provider-lock`, версия `0.656.0`;
