...
- backend на .NET 9: `1606/1606` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-24-live-vps-partial-evidence`, версия `0.752.0`;
...
- roadmap progress: `776/796` closed, readiness `97.5%`, `20` remaining, `19` open, `1` in progress and `0` blocked;
