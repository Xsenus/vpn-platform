...
- backend на .NET 9: `1381/1381` unit tests;
...
- backend `1381/1381`, frontend `161/161`, app release CRUD/conflict/modal/overlap/focused responsive Playwright `12/12`, dependency audit `0 vulnerabilities`;
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-13-app-release-boundary`, версия `0.675.0`;
