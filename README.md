...
- desktop/mobile browser flow сохраняет VPN access status/disabledAt/revision через disable/reload/enable/sync/reset-traffic, не раскрывает terminal access secrets и очищает cached QR до повторной проверки;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-10-stale-qr-cache-invalidation`, версия `0.585.0`;
