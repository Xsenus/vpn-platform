...
- backend на .NET 9: `1501/1501` unit tests;
...
- roadmap progress: `732/752` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress and `0` blocked;
