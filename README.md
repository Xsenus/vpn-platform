...
- backend на .NET 9: `674/674` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-07-02-vpn-live-smoke-generator-release-guard-cleanup`, версия `0.379.0`;
