...
- backend на .NET 9: `657/657` unit tests;
...
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-07-02-production-handoff-ci-summary-latest-release-guard-cleanup`, версия `0.362.0`;
