...
- backend на .NET 9: `1495/1495` unit tests;
...
- roadmap progress: `728/748` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress and `0` blocked;
