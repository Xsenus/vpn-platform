...
- backend на .NET 9: `1424/1424` unit tests;
- API Release build: без ошибок и предупреждений;
- frontend unit tests: `169/169`;
...
- backend `1424/1424`, frontend `169/169`, tariff stale PATCH/DELETE desktop/mobile Playwright `4/4`, dependency audit `0 vulnerabilities`;
- changelog, финальный runbook, release decision, roadmap, продуктовый UI-roadmap и журнал ошибок синхронизированы с разделом "Что нового": `2026-08-13-tariff-boundary`, версия `0.679.0`;
