...
public class ReleaseDocumentationGuardTests
{
    ...
    [
        ...
        new("P11-ACC-153", "2026-07-02-status-docs-production-ready-claim-guard"),
        new("P11-ACC-154", "2026-07-02-latest-release-evidence-caveat-guard"),
        new("P11-ACC-155", "2026-07-02-docs-strict-utf8-guard"),
        new("P11-ACC-156", "2026-07-02-agent-instructions-readable-utf8-guard"),
        ...
        new("P11-ACC-161", "2026-07-02-env-example-utf8-guard"),
        new("P11-ACC-162", "2026-07-02-deploy-frontend-text-utf8-guard"),
        new("P11-ACC-163", "2026-07-02-all-markdown-utf8-guard"),
        new("P11-ACC-164", "2026-07-02-status-docs-progress-consistency-guard"),
