...
public class FinalDocsChangelogTests
{
    ...
    public void Final_Runbook_Changelog_And_Readme_Should_Be_Linked()
    {
        ...
        Assert.Contains("2026-08-05-refresh-token-family-boundary", readme, StringComparison.OrdinalIgnoreCase);
    ...
    public void Final_Runbook_Should_Keep_Current_External_Evidence_Limits_Explicit()
    {
        ...
        foreach (var expected in new[]
                 {
                     "1032/1032",
                     "2026-08-05-refresh-token-family-boundary",
                     "0.504.0",
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "1",
                     "0 blockers",
                     "Backend full suite: OK, `1032/1032`",
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "PostgreSQL SQL",
                     "secret scan `627` files, `0` findings"
                 })
        {
