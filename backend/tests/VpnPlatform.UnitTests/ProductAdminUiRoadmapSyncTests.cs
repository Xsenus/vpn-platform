...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-15-server-archive-provisioning-readonly",
                     "0.748.0"
                 })
        {
        ...
        Assert.Contains("2026-08-15-server-archive-provisioning-readonly", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-15-server-archive-provisioning-readonly", releases, StringComparison.OrdinalIgnoreCase);
    }
