...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-23-admin-bootstrap-password-env-name-guard",
                     "0.287.0"
                 })
        {
        ...
        Assert.Contains("2026-06-23-admin-bootstrap-password-env-name-guard", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-23-admin-bootstrap-password-env-name-guard", releases, StringComparison.OrdinalIgnoreCase);
    }
