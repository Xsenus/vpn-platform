...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Playwright public/cabinet/admin/all-screens/mobile/console smoke: `184/184`",
                     "Fresh local SQLite smoke: OK",
                     "Local SQLite VPS smoke dry-run: OK",
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-11-admin-concurrent-busy-resource-owner",
                     "0.624.0"
                 })
        {
        ...
        Assert.Contains("2026-08-11-admin-concurrent-busy-resource-owner", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-11-admin-concurrent-busy-resource-owner", releases, StringComparison.OrdinalIgnoreCase);
    }
