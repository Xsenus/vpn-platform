...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-07-02-release-seed-identity-guard",
                     "0.427.0"
                 })
        {
        ...
        Assert.Contains("2026-07-02-release-seed-identity-guard", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-07-02-release-seed-identity-guard", releases, StringComparison.OrdinalIgnoreCase);
    }
