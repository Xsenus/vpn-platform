...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-05-checkout-claim-atomicity",
                     "0.515.0"
                 })
        {
        ...
        Assert.Contains("2026-08-05-checkout-claim-atomicity", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-05-checkout-claim-atomicity", releases, StringComparison.OrdinalIgnoreCase);
    }
