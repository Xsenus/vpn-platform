...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-10-password-reset-form-separation",
                     "0.584.0"
                 })
        {
        ...
        Assert.Contains("2026-08-10-password-reset-form-separation", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-10-password-reset-form-separation", releases, StringComparison.OrdinalIgnoreCase);
    }
