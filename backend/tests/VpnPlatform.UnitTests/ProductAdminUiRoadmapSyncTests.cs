...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        Assert.Contains("2026-08-05-x3ui-inbound-update-reconciliation", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-05-x3ui-inbound-update-reconciliation", releases, StringComparison.OrdinalIgnoreCase);
    }
