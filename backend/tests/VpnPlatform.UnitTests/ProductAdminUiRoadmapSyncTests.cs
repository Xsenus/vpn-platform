...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-04-telegram-update-recovery",
                     "0.467.0"
                 })
        {
        ...
        Assert.Contains("2026-08-04-telegram-update-recovery", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-04-telegram-update-recovery", releases, StringComparison.OrdinalIgnoreCase);
    }
