...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-07-02-agent-unavailable-checks-risk-guard",
                     "0.445.0"
                 })
        {
        ...
        Assert.Contains("2026-07-02-agent-unavailable-checks-risk-guard", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-07-02-agent-unavailable-checks-risk-guard", releases, StringComparison.OrdinalIgnoreCase);
    }
