...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-24-live-vps-partial-evidence",
                     "0.752.0"
                 })
        {
        ...
        Assert.Contains("2026-08-24-live-vps-partial-evidence", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-24-live-vps-partial-evidence", releases, StringComparison.OrdinalIgnoreCase);
    }
