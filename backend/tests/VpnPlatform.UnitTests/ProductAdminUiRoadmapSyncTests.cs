...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-23-local-admin-bootstrap-port-guard",
                     "0.264.0"
                 })
        {
        ...
        Assert.Contains("2026-06-23-local-admin-bootstrap-port-guard", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-23-local-admin-bootstrap-port-guard", releases, StringComparison.OrdinalIgnoreCase);
    }
