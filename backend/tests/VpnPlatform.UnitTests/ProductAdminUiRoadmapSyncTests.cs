...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        Assert.Contains("2026-08-04-telegram-notification-dispatch-recovery", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-04-telegram-notification-dispatch-recovery", releases, StringComparison.OrdinalIgnoreCase);
    }
