...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-18-production-readiness-assertion-result-validator",
                     "0.157.0"
                 })
        {
        ...
        Assert.Contains("2026-06-18-production-readiness-assertion-result-validator", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-18-production-readiness-assertion-result-validator", releases, StringComparison.OrdinalIgnoreCase);
    }
