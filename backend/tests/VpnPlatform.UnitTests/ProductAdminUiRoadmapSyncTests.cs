...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Playwright public/cabinet/admin/all-screens/mobile/console smoke: `216/216`",
        ...
        Assert.Contains("2026-08-12-admin-access-grace-expiry", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-12-admin-access-grace-expiry", releases, StringComparison.OrdinalIgnoreCase);
    }
