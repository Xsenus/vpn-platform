...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-07-02-release-seed-secret-literal-guard",
                     "0.430.0"
                 })
        {
        ...
        Assert.Contains("2026-07-02-release-seed-secret-literal-guard", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-07-02-release-seed-secret-literal-guard", releases, StringComparison.OrdinalIgnoreCase);
    }
