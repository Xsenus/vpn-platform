...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-22-admin-vps-smoke-evidence-report-id-timestamp",
                     "0.246.0"
                 })
        {
        ...
        Assert.Contains("2026-06-22-admin-vps-smoke-evidence-report-id-timestamp", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-22-admin-vps-smoke-evidence-report-id-timestamp", releases, StringComparison.OrdinalIgnoreCase);
    }
