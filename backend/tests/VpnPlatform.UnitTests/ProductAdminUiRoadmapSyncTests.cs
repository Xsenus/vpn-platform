...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-23-admin-vps-readiness-provider-mode",
                     "0.273.0"
                 })
        {
        ...
        Assert.Contains("2026-06-23-admin-vps-readiness-provider-mode", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-23-admin-vps-readiness-provider-mode", releases, StringComparison.OrdinalIgnoreCase);
    }
