...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-20-admin-vps-smoke-admin-email-evidence",
                     "0.206.0"
                 })
        {
        ...
        Assert.Contains("2026-06-20-admin-vps-smoke-admin-email-evidence", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-20-admin-vps-smoke-admin-email-evidence", releases, StringComparison.OrdinalIgnoreCase);
    }
