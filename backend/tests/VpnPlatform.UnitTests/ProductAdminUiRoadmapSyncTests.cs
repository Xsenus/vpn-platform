...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        Assert.Contains("2026-07-02-status-docs-progress-consistency-guard", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-07-02-status-docs-progress-consistency-guard", releases, StringComparison.OrdinalIgnoreCase);
    }
