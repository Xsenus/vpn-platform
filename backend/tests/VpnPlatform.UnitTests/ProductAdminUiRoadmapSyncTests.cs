...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-19-production-readiness-assertion-ci-result-validator-regression",
                     "0.161.0"
                 })
        {
        ...
        Assert.Contains("2026-06-19-production-readiness-assertion-ci-result-validator-regression", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-19-production-readiness-assertion-ci-result-validator-regression", releases, StringComparison.OrdinalIgnoreCase);
    }
