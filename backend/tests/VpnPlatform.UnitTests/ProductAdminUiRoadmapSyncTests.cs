...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-10-admin-action-capability-boundary",
                     "0.581.0"
                 })
        {
        ...
        Assert.Contains("2026-08-10-admin-action-capability-boundary", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-10-admin-action-capability-boundary", releases, StringComparison.OrdinalIgnoreCase);
    }
