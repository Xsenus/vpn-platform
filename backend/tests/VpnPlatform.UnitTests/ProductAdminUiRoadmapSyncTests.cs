...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-13-admin-finance-read-boundary",
                     "0.687.0"
                 })
        {
        ...
        Assert.Contains("2026-08-13-admin-finance-read-boundary", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-13-admin-finance-read-boundary", releases, StringComparison.OrdinalIgnoreCase);
    }
