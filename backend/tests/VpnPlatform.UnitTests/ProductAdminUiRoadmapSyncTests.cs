...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-07-02-admin-vps-browser-smoke-direct-release-guard-cleanup",
                     "0.384.0"
                 })
        {
        ...
        Assert.Contains("2026-07-02-admin-vps-browser-smoke-direct-release-guard-cleanup", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-07-02-admin-vps-browser-smoke-direct-release-guard-cleanup", releases, StringComparison.OrdinalIgnoreCase);
    }
