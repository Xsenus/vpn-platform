...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-24-deploy-production-env-normalizer",
                     "0.289.0"
                 })
        {
        ...
        Assert.Contains("2026-06-24-deploy-production-env-normalizer", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-24-deploy-production-env-normalizer", releases, StringComparison.OrdinalIgnoreCase);
    }
