...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        Assert.Contains("2026-08-15-admin-scenario-lifecycle-and-local-sqlite-repair", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-15-admin-scenario-lifecycle-and-local-sqlite-repair", releases, StringComparison.OrdinalIgnoreCase);
    }
