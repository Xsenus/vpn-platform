...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-19-production-readiness-assertion-ci-artifacts-validator",
                     "0.164.0"
                 })
        {
        ...
        Assert.Contains("2026-06-19-production-readiness-assertion-ci-artifacts-validator", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-19-production-readiness-assertion-ci-artifacts-validator", releases, StringComparison.OrdinalIgnoreCase);
    }
