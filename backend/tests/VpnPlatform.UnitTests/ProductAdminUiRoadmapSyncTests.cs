...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-22-admin-vps-bootstrap-evidence-readiness-inputs-summary",
                     "0.229.0"
                 })
        {
        ...
        Assert.Contains("2026-06-22-admin-vps-bootstrap-evidence-readiness-inputs-summary", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-22-admin-vps-bootstrap-evidence-readiness-inputs-summary", releases, StringComparison.OrdinalIgnoreCase);
    }
