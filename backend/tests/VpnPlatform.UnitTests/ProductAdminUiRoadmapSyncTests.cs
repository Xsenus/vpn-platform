...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-23-admin-vps-readiness-provider-normalization",
                     "0.274.0"
                 })
        {
        ...
        Assert.Contains("2026-06-23-admin-vps-readiness-provider-normalization", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-23-admin-vps-readiness-provider-normalization", releases, StringComparison.OrdinalIgnoreCase);
    }
