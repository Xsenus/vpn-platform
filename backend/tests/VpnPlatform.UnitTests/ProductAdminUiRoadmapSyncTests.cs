...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-05-provisioning-cancel-claim-boundary",
                     "0.514.0"
                 })
        {
        ...
        Assert.Contains("2026-08-05-provisioning-cancel-claim-boundary", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-05-provisioning-cancel-claim-boundary", releases, StringComparison.OrdinalIgnoreCase);
    }
