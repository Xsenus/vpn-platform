...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-11-public-catalog-load-single-flight",
                     "0.616.0"
                 })
        {
        ...
        Assert.Contains("2026-08-11-public-catalog-load-single-flight", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-11-public-catalog-load-single-flight", releases, StringComparison.OrdinalIgnoreCase);
    }
