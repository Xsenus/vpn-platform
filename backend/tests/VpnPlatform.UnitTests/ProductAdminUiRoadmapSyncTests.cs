...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-14-admin-crud-clock-and-capacity-gates",
                     "0.713.0"
                 })
        {
        ...
        Assert.Contains("2026-08-14-admin-crud-clock-and-capacity-gates", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-14-admin-crud-clock-and-capacity-gates", releases, StringComparison.OrdinalIgnoreCase);
    }
