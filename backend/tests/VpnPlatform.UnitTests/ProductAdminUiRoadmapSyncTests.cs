...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-13-own-vps-latest-read-boundary",
                     "0.700.0"
                 })
        {
        ...
        Assert.Contains("2026-08-13-own-vps-latest-read-boundary", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-13-own-vps-latest-read-boundary", releases, StringComparison.OrdinalIgnoreCase);
    }
