...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-07-01-production-handoff-package-archive-ci-regression-default-cleanup",
                     "0.354.0"
                 })
        {
        ...
        Assert.Contains("2026-07-01-production-handoff-package-archive-ci-regression-default-cleanup", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-07-01-production-handoff-package-archive-ci-regression-default-cleanup", releases, StringComparison.OrdinalIgnoreCase);
    }
