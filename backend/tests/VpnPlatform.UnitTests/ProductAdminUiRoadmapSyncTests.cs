...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-22-admin-vps-smoke-env-max-duration",
                     "0.257.0"
                 })
        {
        ...
        Assert.Contains("2026-06-22-admin-vps-smoke-env-max-duration", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-22-admin-vps-smoke-env-max-duration", releases, StringComparison.OrdinalIgnoreCase);
    }
