...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Frontend unit tests: `100/100`",
                     "Playwright public/cabinet/admin/all-screens/mobile/console smoke: `18/18`",
                     "Fresh local SQLite smoke: OK",
                     "Local SQLite VPS smoke dry-run: OK",
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-09-admin-content-api-dto-validation",
                     "0.533.0"
                 })
        {
        ...
        Assert.Contains("2026-08-09-admin-content-api-dto-validation", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-09-admin-content-api-dto-validation", releases, StringComparison.OrdinalIgnoreCase);
    }
