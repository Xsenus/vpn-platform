...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-23-admin-vps-readiness-environment-default",
                     "0.275.0"
                 })
        {
        ...
        Assert.Contains("2026-06-23-admin-vps-readiness-environment-default", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-23-admin-vps-readiness-environment-default", releases, StringComparison.OrdinalIgnoreCase);
    }
