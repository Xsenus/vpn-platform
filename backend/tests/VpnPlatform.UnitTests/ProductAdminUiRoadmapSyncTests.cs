...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Playwright public/cabinet/admin/all-screens/mobile/console smoke: `156/156`",
                     "Fresh local SQLite smoke: OK",
                     "Local SQLite VPS smoke dry-run: OK",
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-11-public-checkout-session-boundary",
                     "0.605.0"
                 })
        {
        ...
        Assert.Contains("2026-08-11-public-checkout-session-boundary", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-11-public-checkout-session-boundary", releases, StringComparison.OrdinalIgnoreCase);
    }
