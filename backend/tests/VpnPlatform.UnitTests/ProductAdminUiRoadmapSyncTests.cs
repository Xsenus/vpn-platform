...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Playwright public/cabinet/admin/all-screens/mobile/console smoke: `84/84`",
                     "Fresh local SQLite smoke: OK",
                     "Local SQLite VPS smoke dry-run: OK",
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-10-admin-payment-provider-secure-lifecycle-e2e",
                     "0.556.0"
                 })
        {
        ...
        Assert.Contains("2026-08-10-admin-payment-provider-secure-lifecycle-e2e", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-10-admin-payment-provider-secure-lifecycle-e2e", releases, StringComparison.OrdinalIgnoreCase);
    }
