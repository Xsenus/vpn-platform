...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-07-02-admin-vps-smoke-preflight-validator-cleanup",
                     "0.388.0"
                 })
        {
        ...
        Assert.Contains("2026-07-02-admin-vps-smoke-preflight-validator-cleanup", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-07-02-admin-vps-smoke-preflight-validator-cleanup", releases, StringComparison.OrdinalIgnoreCase);
    }
