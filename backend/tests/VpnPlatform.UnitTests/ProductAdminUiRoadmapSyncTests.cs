...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-18-production-readiness-assertion-ci-regression",
                     "0.159.0"
                 })
        {
        ...
        Assert.Contains("2026-06-18-production-readiness-assertion-ci-regression", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-18-production-readiness-assertion-ci-regression", releases, StringComparison.OrdinalIgnoreCase);
    }
