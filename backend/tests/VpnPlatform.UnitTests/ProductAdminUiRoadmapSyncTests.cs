...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-19-production-readiness-assertion-ci-workflow-artifacts-guard-regression",
                     "0.171.0"
                 })
        {
        ...
        Assert.Contains("2026-06-19-production-readiness-assertion-ci-workflow-artifacts-guard-regression", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-19-production-readiness-assertion-ci-workflow-artifacts-guard-regression", releases, StringComparison.OrdinalIgnoreCase);
    }
