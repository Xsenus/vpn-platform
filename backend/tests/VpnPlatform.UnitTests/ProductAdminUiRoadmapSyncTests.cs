...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-06-19-staging-smoke-report-evidence-placeholders",
                     "0.181.0"
                 })
        {
        ...
        Assert.Contains("2026-06-19-staging-smoke-report-evidence-placeholders", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-06-19-staging-smoke-report-evidence-placeholders", releases, StringComparison.OrdinalIgnoreCase);
    }
