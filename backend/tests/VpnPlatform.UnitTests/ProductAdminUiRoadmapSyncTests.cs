...
public class ProductAdminUiRoadmapSyncTests
{
    ...
    public void Product_Admin_Ui_Roadmap_Should_Reflect_Current_Product_Status()
    {
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "Encoding guard: OK",
                     "Secret scan: OK",
                     "2026-08-15-server-archive-active-workload-guard",
                     "0.749.0"
                 })
        {
        ...
        Assert.Contains("2026-08-15-server-archive-active-workload-guard", testResults, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("2026-08-15-server-archive-active-workload-guard", releases, StringComparison.OrdinalIgnoreCase);
    }
