...
{
    private const string CurrentReleaseId = "2026-06-19-production-evidence-ci-workflow-artifacts-guard";
    private const string CurrentVersion = "0.169.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("555/555", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("555/555", readme, StringComparison.Ordinal);
        Assert.Contains("555/555", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("555/555", releaseDecision, StringComparison.Ordinal);
