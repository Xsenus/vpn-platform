...
{
    private const string CurrentReleaseId = "2026-08-12-cabinet-payment-link-expiry";
    private const string CurrentVersion = "0.632.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("[x] `STATE-002` Frontend test suite проходит: `132/132`.", roadmap, StringComparison.Ordinal);
