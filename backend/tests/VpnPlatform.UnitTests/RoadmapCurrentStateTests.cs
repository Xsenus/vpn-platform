...
{
    private const string CurrentReleaseId = "2026-08-05-admin-dashboard-domain-redaction";
    private const string CurrentVersion = "0.495.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("999/999", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("999/999", readme, StringComparison.Ordinal);
        Assert.Contains("999/999", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("999/999", releaseDecision, StringComparison.Ordinal);
