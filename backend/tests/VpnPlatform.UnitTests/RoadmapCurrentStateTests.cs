...
{
    private const string CurrentReleaseId = "2026-07-02-admin-vps-smoke-evidence-validator-cleanup";
    private const string CurrentVersion = "0.389.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("684/684", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("684/684", readme, StringComparison.Ordinal);
        Assert.Contains("684/684", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("684/684", releaseDecision, StringComparison.Ordinal);
