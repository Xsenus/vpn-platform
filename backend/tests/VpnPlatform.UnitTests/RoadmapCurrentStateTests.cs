...
{
    private const string CurrentReleaseId = "2026-07-02-vpn-live-smoke-generator-release-guard-cleanup";
    private const string CurrentVersion = "0.379.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("674/674", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("674/674", readme, StringComparison.Ordinal);
        Assert.Contains("674/674", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("674/674", releaseDecision, StringComparison.Ordinal);
