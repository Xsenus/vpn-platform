...
{
    private const string CurrentReleaseId = "2026-06-19-production-readiness-assertion-ci-result-validator";
    private const string CurrentVersion = "0.160.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("546/546", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("546/546", readme, StringComparison.Ordinal);
        Assert.Contains("546/546", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("546/546", releaseDecision, StringComparison.Ordinal);
