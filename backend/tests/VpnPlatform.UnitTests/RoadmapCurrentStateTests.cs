...
{
    private const string CurrentReleaseId = "2026-06-14-production-readiness-gate";
    private const string CurrentVersion = "0.112.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("486/486", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("486/486", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("486/486", releaseDecision, StringComparison.Ordinal);
