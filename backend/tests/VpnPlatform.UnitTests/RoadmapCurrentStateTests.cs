...
{
    private const string CurrentReleaseId = "2026-06-19-admin-bootstrap-wrapper";
    private const string CurrentVersion = "0.182.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("573/573", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("573/573", readme, StringComparison.Ordinal);
        Assert.Contains("573/573", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("573/573", releaseDecision, StringComparison.Ordinal);
