...
{
    private const string CurrentReleaseId = "2026-08-05-email-delivery-lifecycle";
    private const string CurrentVersion = "0.518.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("1098/1098", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("1098/1098", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("1098/1098", releaseDecision, StringComparison.Ordinal);
