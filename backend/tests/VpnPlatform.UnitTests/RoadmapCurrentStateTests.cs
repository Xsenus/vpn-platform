...
{
    private const string CurrentReleaseId = "2026-07-02-test-results-external-evidence-open-guard";
    private const string CurrentVersion = "0.419.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("712/712", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("712/712", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("712/712", releaseDecision, StringComparison.Ordinal);
