...
{
    private const string CurrentReleaseId = "2026-06-18-production-evidence-bundle-gate";
    private const string CurrentVersion = "0.124.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("510/510", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("510/510", readme, StringComparison.Ordinal);
        Assert.Contains("510/510", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("510/510", releaseDecision, StringComparison.Ordinal);
