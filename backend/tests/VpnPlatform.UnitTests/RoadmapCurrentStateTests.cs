...
{
    private const string CurrentReleaseId = "2026-06-19-production-ci-workflow-artifacts-guards-aggregate-ci-step-guards";
    private const string CurrentVersion = "0.177.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("563/563", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("563/563", readme, StringComparison.Ordinal);
        Assert.Contains("563/563", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("563/563", releaseDecision, StringComparison.Ordinal);
