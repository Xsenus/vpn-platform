...
{
    private const string CurrentReleaseId = "2026-07-02-admin-vps-smoke-sections-contract-cleanup";
    private const string CurrentVersion = "0.398.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("693/693", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("693/693", readme, StringComparison.Ordinal);
        Assert.Contains("693/693", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("693/693", releaseDecision, StringComparison.Ordinal);
