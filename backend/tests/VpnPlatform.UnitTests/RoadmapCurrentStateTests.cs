...
{
    private const string CurrentReleaseId = "2026-07-02-production-handoff-receipt-release-guard-cleanup";
    private const string CurrentVersion = "0.369.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("664/664", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("664/664", readme, StringComparison.Ordinal);
        Assert.Contains("664/664", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("664/664", releaseDecision, StringComparison.Ordinal);
