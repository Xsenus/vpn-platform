...
{
    private const string CurrentReleaseId = "2026-06-14-telegram-stars-invoice-gate";
    private const string CurrentVersion = "0.118.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("495/495", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("495/495", readme, StringComparison.Ordinal);
        Assert.Contains("495/495", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("495/495", releaseDecision, StringComparison.Ordinal);
