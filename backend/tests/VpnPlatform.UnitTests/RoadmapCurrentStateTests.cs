...
{
    private const string CurrentReleaseId = "2026-06-19-vps-production-smoke-report-contract";
    private const string CurrentVersion = "0.179.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("568/568", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("568/568", readme, StringComparison.Ordinal);
        Assert.Contains("568/568", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("568/568", releaseDecision, StringComparison.Ordinal);
