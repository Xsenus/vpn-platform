...
{
    private const string CurrentReleaseId = "2026-06-19-production-readiness-assertion-ci-step-summary-smoke";
    private const string CurrentVersion = "0.163.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("549/549", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("549/549", readme, StringComparison.Ordinal);
        Assert.Contains("549/549", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("549/549", releaseDecision, StringComparison.Ordinal);
