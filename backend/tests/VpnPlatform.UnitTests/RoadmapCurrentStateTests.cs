...
{
    private const string CurrentReleaseId = "2026-07-02-vps-production-smoke-report-self-link";
    private const string CurrentVersion = "0.405.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("700/700", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("700/700", readme, StringComparison.Ordinal);
        Assert.Contains("700/700", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("700/700", releaseDecision, StringComparison.Ordinal);
