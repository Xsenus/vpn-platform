...
{
    private const string CurrentReleaseId = "2026-07-02-production-handoff-package-archive-latest-release-guard-cleanup";
    private const string CurrentVersion = "0.363.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("658/658", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("658/658", readme, StringComparison.Ordinal);
        Assert.Contains("658/658", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("658/658", releaseDecision, StringComparison.Ordinal);
