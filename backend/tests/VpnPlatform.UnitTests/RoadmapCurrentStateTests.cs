...
{
    private const string CurrentReleaseId = "2026-07-01-production-handoff-package-latest-release-guard";
    private const string CurrentVersion = "0.306.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("601/601", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("601/601", readme, StringComparison.Ordinal);
        Assert.Contains("601/601", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("601/601", releaseDecision, StringComparison.Ordinal);
