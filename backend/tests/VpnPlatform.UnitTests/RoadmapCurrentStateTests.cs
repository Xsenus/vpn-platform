...
{
    private const string CurrentReleaseId = "2026-07-01-production-handoff-package-archive-dotdot-entry-guard";
    private const string CurrentVersion = "0.338.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("633/633", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("633/633", readme, StringComparison.Ordinal);
        Assert.Contains("633/633", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("633/633", releaseDecision, StringComparison.Ordinal);
