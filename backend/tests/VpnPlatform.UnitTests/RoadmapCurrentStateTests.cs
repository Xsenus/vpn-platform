...
{
    private const string CurrentReleaseId = "2026-07-02-agent-encoding-verification-guard";
    private const string CurrentVersion = "0.451.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("734/734", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("734/734", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("734/734", releaseDecision, StringComparison.Ordinal);
