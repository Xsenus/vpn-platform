...
{
    private const string CurrentReleaseId = "2026-07-02-agent-verification-handoff-guard";
    private const string CurrentVersion = "0.450.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("733/733", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("733/733", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("733/733", releaseDecision, StringComparison.Ordinal);
