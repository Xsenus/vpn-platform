...
{
    private const string CurrentReleaseId = "2026-06-18-production-evidence-handoff-package";
    private const string CurrentVersion = "0.138.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("524/524", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("524/524", readme, StringComparison.Ordinal);
        Assert.Contains("524/524", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("524/524", releaseDecision, StringComparison.Ordinal);
