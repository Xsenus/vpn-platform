...
{
    private const string CurrentReleaseId = "2026-07-02-deploy-vps-docker-tmp-cleanup";
    private const string CurrentVersion = "0.401.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("696/696", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("696/696", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("696/696", releaseDecision, StringComparison.Ordinal);
