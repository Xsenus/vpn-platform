...
{
    private const string CurrentReleaseId = "2026-08-05-payment-provider-configuration-check";
    private const string CurrentVersion = "0.486.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("984/984", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `STATE-002`", roadmap, StringComparison.Ordinal);
        Assert.Contains("68/68", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("984/984", readme, StringComparison.Ordinal);
        Assert.Contains("984/984", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("984/984", releaseDecision, StringComparison.Ordinal);
