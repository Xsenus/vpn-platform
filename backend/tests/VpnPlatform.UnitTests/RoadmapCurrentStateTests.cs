...
{
    private const string CurrentReleaseId = "2026-08-04-x3ui-failure-compensation-hardening";
    private const string CurrentVersion = "0.460.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("809/809", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("809/809", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("809/809", releaseDecision, StringComparison.Ordinal);
