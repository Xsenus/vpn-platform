...
{
    private const string CurrentReleaseId = "2026-07-02-production-evidence-bundle-generator-release-guard-cleanup";
    private const string CurrentVersion = "0.376.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("671/671", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("671/671", readme, StringComparison.Ordinal);
        Assert.Contains("671/671", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("671/671", releaseDecision, StringComparison.Ordinal);
