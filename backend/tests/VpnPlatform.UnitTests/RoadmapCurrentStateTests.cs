...
{
    private const string CurrentReleaseId = "2026-07-01-production-evidence-bundle-generator-release-guard";
    private const string CurrentVersion = "0.325.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("620/620", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("620/620", readme, StringComparison.Ordinal);
        Assert.Contains("620/620", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("620/620", releaseDecision, StringComparison.Ordinal);
