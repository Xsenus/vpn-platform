...
{
    private const string CurrentReleaseId = "2026-08-04-subscription-activation-compensation";
    private const string CurrentVersion = "0.466.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("843/843", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("843/843", readme, StringComparison.Ordinal);
        Assert.Contains("843/843", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("843/843", releaseDecision, StringComparison.Ordinal);
