...
{
    private const string CurrentReleaseId = "2026-08-05-refresh-token-rotation-concurrency";
    private const string CurrentVersion = "0.508.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("1043/1043", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("1043/1043", readme, StringComparison.Ordinal);
        Assert.Contains("1043/1043", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("1043/1043", releaseDecision, StringComparison.Ordinal);
