...
{
    private const string CurrentReleaseId = "2026-06-24-admin-vps-smoke-remote-release-console-summary";
    private const string CurrentVersion = "0.293.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("593/593", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("593/593", readme, StringComparison.Ordinal);
        Assert.Contains("593/593", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("593/593", releaseDecision, StringComparison.Ordinal);
