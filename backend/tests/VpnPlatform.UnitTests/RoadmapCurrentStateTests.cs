...
{
    private const string CurrentReleaseId = "2026-08-31-production-admin-and-threexui-api-token";
    private const string CurrentVersion = "0.755.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("[x] `STATE-001` Backend test suite проходит: `1619/1619`.", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("admin-vps-smoke-2026-08-31.json", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-487`", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("[x] `P11-ACC-483`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-482`", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("[x] `P11-ACC-467`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-465`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-460`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-459`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-458`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-457`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-456`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-455`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-454`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-453`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-452`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-450`", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("[x] `P11-ACC-445`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-444`", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("[x] `P11-ACC-438`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-437`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-436`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-433`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-431`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-430`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-429`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-428`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-427`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-426`", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("1619/1619", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("1619/1619", releaseDecision, StringComparison.Ordinal);
