...
{
    private const string CurrentReleaseId = "2026-06-14-product-admin-roadmap-sync";
    private const string CurrentVersion = "0.111.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("484/484", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("484/484", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("484/484", releaseDecision, StringComparison.Ordinal);
