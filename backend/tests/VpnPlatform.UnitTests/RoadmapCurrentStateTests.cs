...
{
    private const string CurrentReleaseId = "2026-07-02-production-handoff-package-latest-release-guard-cleanup";
    private const string CurrentVersion = "0.371.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("666/666", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("666/666", readme, StringComparison.Ordinal);
        Assert.Contains("666/666", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("666/666", releaseDecision, StringComparison.Ordinal);
