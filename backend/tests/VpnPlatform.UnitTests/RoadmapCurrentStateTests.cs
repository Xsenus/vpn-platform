...
{
    private const string CurrentReleaseId = "2026-06-18-production-evidence-archive-validator";
    private const string CurrentVersion = "0.133.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("519/519", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("519/519", readme, StringComparison.Ordinal);
        Assert.Contains("519/519", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("519/519", releaseDecision, StringComparison.Ordinal);
