...
{
    private const string CurrentReleaseId = "2026-07-01-production-handoff-receipt-release-guard";
    private const string CurrentVersion = "0.328.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("623/623", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("623/623", readme, StringComparison.Ordinal);
        Assert.Contains("623/623", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("623/623", releaseDecision, StringComparison.Ordinal);
