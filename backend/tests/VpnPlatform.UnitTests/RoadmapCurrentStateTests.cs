...
{
    private const string CurrentReleaseId = "2026-07-02-vps-production-smoke-latest-release-guard-cleanup";
    private const string CurrentVersion = "0.378.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("673/673", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("673/673", readme, StringComparison.Ordinal);
        Assert.Contains("673/673", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("673/673", releaseDecision, StringComparison.Ordinal);
