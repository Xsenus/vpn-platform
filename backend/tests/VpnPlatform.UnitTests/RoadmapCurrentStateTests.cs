...
{
    private const string CurrentReleaseId = "2026-07-02-admin-vps-smoke-report-validator-cleanup";
    private const string CurrentVersion = "0.387.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("682/682", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("682/682", readme, StringComparison.Ordinal);
        Assert.Contains("682/682", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("682/682", releaseDecision, StringComparison.Ordinal);
