...
{
    private const string CurrentReleaseId = "2026-07-02-production-handoff-receipt-verified-files-guard-cleanup";
    private const string CurrentVersion = "0.372.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("667/667", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("667/667", readme, StringComparison.Ordinal);
        Assert.Contains("667/667", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("667/667", releaseDecision, StringComparison.Ordinal);
