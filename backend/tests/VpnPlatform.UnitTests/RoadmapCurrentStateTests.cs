...
{
    private const string CurrentReleaseId = "2026-06-19-admin-vps-smoke-flow-wrapper-regression";
    private const string CurrentVersion = "0.191.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("582/582", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("582/582", readme, StringComparison.Ordinal);
        Assert.Contains("582/582", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("582/582", releaseDecision, StringComparison.Ordinal);
