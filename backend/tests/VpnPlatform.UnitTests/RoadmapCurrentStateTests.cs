...
{
    private const string CurrentReleaseId = "2026-08-10-admin-provisioning-validation-lifecycle-e2e";
    private const string CurrentVersion = "0.559.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("112/112", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("[x] `P11-ACC-282`", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("1112/1112", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("1112/1112", releaseDecision, StringComparison.Ordinal);
