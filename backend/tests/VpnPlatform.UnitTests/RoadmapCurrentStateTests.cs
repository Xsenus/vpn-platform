...
{
    private const string CurrentReleaseId = "2026-07-02-production-readiness-summary-self-link";
    private const string CurrentVersion = "0.409.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("704/704", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("704/704", readme, StringComparison.Ordinal);
        Assert.Contains("704/704", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("704/704", releaseDecision, StringComparison.Ordinal);
