...
{
    private const string CurrentReleaseId = "2026-06-14-staging-smoke-report-url-validation";
    private const string CurrentVersion = "0.115.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("489/489", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `STATE-002`", roadmap, StringComparison.Ordinal);
        Assert.Contains("65/65", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("489/489", readme, StringComparison.Ordinal);
        Assert.Contains("489/489", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("489/489", releaseDecision, StringComparison.Ordinal);
