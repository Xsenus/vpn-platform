...
{
    private const string CurrentReleaseId = "2026-06-18-production-evidence-bundle-validator";
    private const string CurrentVersion = "0.129.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("515/515", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("515/515", readme, StringComparison.Ordinal);
        Assert.Contains("515/515", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("515/515", releaseDecision, StringComparison.Ordinal);
