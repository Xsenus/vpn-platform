...
{
    private const string CurrentReleaseId = "2026-06-14-admin-vps-smoke-report";
    private const string CurrentVersion = "0.122.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("505/505", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("505/505", readme, StringComparison.Ordinal);
        Assert.Contains("505/505", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("505/505", releaseDecision, StringComparison.Ordinal);
