...
{
    private const string CurrentReleaseId = "2026-06-19-production-readiness-assertion-ci-workflow-guard-step";
    private const string CurrentVersion = "0.168.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("554/554", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("554/554", readme, StringComparison.Ordinal);
        Assert.Contains("554/554", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("554/554", releaseDecision, StringComparison.Ordinal);
