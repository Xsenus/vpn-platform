...
{
    private const string CurrentReleaseId = "2026-07-02-product-ui-external-evidence-open-guard";
    private const string CurrentVersion = "0.416.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("709/709", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("709/709", readme, StringComparison.Ordinal);
        Assert.Contains("709/709", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("709/709", releaseDecision, StringComparison.Ordinal);
