...
{
    private const string CurrentReleaseId = "2026-07-01-production-handoff-package-archive-whitespace-entry-cleanup";
    private const string CurrentVersion = "0.351.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("646/646", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("646/646", readme, StringComparison.Ordinal);
        Assert.Contains("646/646", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("646/646", releaseDecision, StringComparison.Ordinal);
