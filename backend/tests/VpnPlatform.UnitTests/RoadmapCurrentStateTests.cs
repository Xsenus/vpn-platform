...
{
    private const string CurrentReleaseId = "2026-06-19-staging-smoke-report-evidence-placeholders";
    private const string CurrentVersion = "0.181.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("570/570", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("570/570", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("570/570", releaseDecision, StringComparison.Ordinal);
