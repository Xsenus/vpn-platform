...
{
    private const string CurrentReleaseId = "2026-06-14-provisioning-secret-bug-sync";
    private const string CurrentVersion = "0.110.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("483/483", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("483/483", readme, StringComparison.Ordinal);
        Assert.Contains("483/483", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("483/483", releaseDecision, StringComparison.Ordinal);
