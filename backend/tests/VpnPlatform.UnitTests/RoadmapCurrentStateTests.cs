...
{
    private const string CurrentReleaseId = "2026-08-05-vpn-access-cancellation-reconciliation";
    private const string CurrentVersion = "0.497.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("1008/1008", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("1008/1008", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("1008/1008", releaseDecision, StringComparison.Ordinal);
