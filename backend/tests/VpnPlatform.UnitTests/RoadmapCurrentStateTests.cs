...
{
    private const string CurrentReleaseId = "2026-07-02-docker-validation-tmp-cleanup";
    private const string CurrentVersion = "0.400.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("695/695", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("695/695", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("695/695", releaseDecision, StringComparison.Ordinal);
