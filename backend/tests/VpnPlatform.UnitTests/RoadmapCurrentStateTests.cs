...
{
    private const string CurrentReleaseId = "2026-07-02-release-decision-external-evidence-open-guard";
    private const string CurrentVersion = "0.417.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("710/710", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("710/710", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("710/710", releaseDecision, StringComparison.Ordinal);
