...
{
    private const string CurrentReleaseId = "2026-08-04-payment-webhook-recovery";
    private const string CurrentVersion = "0.465.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("839/839", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("839/839", readme, StringComparison.Ordinal);
        Assert.Contains("839/839", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("839/839", releaseDecision, StringComparison.Ordinal);
