...
{
    private const string CurrentReleaseId = "2026-06-19-production-ci-workflow-artifacts-guards-ci-step-regression";
    private const string CurrentVersion = "0.176.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("562/562", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("562/562", readme, StringComparison.Ordinal);
        Assert.Contains("562/562", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("562/562", releaseDecision, StringComparison.Ordinal);
