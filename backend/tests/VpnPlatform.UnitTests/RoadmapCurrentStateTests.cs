...
{
    private const string CurrentReleaseId = "2026-07-01-production-handoff-package-archive-backslash-entry-cleanup";
    private const string CurrentVersion = "0.347.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("642/642", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("642/642", readme, StringComparison.Ordinal);
        Assert.Contains("642/642", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("642/642", releaseDecision, StringComparison.Ordinal);
