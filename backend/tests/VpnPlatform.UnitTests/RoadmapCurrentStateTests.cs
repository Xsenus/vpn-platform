...
{
    private const string CurrentReleaseId = "2026-08-04-x3ui-sync-atomicity-hardening";
    private const string CurrentVersion = "0.461.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("811/811", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("811/811", readme, StringComparison.Ordinal);
        Assert.Contains("811/811", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("811/811", releaseDecision, StringComparison.Ordinal);
