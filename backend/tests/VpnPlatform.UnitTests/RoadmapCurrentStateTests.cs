...
{
    private const string CurrentReleaseId = "2026-06-19-production-readiness-assertion-ci-workflow-artifacts-guard-regression";
    private const string CurrentVersion = "0.171.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("557/557", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("557/557", readme, StringComparison.Ordinal);
        Assert.Contains("557/557", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("557/557", releaseDecision, StringComparison.Ordinal);
