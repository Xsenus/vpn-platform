...
{
    private const string CurrentReleaseId = "2026-07-02-admin-vps-bootstrap-smoke-readiness-cleanup";
    private const string CurrentVersion = "0.397.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("692/692", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("692/692", readme, StringComparison.Ordinal);
        Assert.Contains("692/692", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("692/692", releaseDecision, StringComparison.Ordinal);
