...
{
    private const string CurrentReleaseId = "2026-06-18-production-readiness-assertion-result-validator-regression";
    private const string CurrentVersion = "0.158.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("544/544", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("544/544", readme, StringComparison.Ordinal);
        Assert.Contains("544/544", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("544/544", releaseDecision, StringComparison.Ordinal);
