...
{
    private const string CurrentReleaseId = "2026-07-02-admin-vps-smoke-release-guard-cleanup";
    private const string CurrentVersion = "0.382.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("678/678", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("678/678", readme, StringComparison.Ordinal);
        Assert.Contains("678/678", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("678/678", releaseDecision, StringComparison.Ordinal);
