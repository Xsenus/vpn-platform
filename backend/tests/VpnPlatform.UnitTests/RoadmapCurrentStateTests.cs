...
{
    private const string CurrentReleaseId = "2026-08-09-admin-infrastructure-api-dto-validation";
    private const string CurrentVersion = "0.535.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("102/102", roadmap, StringComparison.Ordinal);
