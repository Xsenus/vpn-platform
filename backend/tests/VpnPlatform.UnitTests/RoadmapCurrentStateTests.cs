...
{
    private const string CurrentReleaseId = "2026-08-04-payment-init-commit-resilience";
    private const string CurrentVersion = "0.464.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("831/831", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("831/831", readme, StringComparison.Ordinal);
        Assert.Contains("831/831", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("831/831", releaseDecision, StringComparison.Ordinal);
