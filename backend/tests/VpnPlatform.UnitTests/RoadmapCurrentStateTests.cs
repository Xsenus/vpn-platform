...
{
    private const string CurrentReleaseId = "2026-08-05-admin-readiness-link-boundary";
    private const string CurrentVersion = "0.524.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("95/95", roadmap, StringComparison.Ordinal);
