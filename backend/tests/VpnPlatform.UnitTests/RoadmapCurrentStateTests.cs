...
{
    private const string CurrentReleaseId = "2026-06-18-production-readiness-summary";
    private const string CurrentVersion = "0.127.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("513/513", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("513/513", readme, StringComparison.Ordinal);
        Assert.Contains("513/513", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("513/513", releaseDecision, StringComparison.Ordinal);
