...
{
    private const string CurrentReleaseId = "2026-08-05-cancelled-subscription-terminal-guard";
    private const string CurrentVersion = "0.499.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("1012/1012", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `STATE-002`", roadmap, StringComparison.Ordinal);
        Assert.Contains("80/80", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("1012/1012", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("1012/1012", releaseDecision, StringComparison.Ordinal);
