...
{
    private const string CurrentReleaseId = "2026-07-01-production-handoff-package-archive-dot-entry-cleanup";
    private const string CurrentVersion = "0.349.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("644/644", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("644/644", readme, StringComparison.Ordinal);
        Assert.Contains("644/644", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("644/644", releaseDecision, StringComparison.Ordinal);
