...
{
    private const string CurrentReleaseId = "2026-08-15-server-editor-noop-draft-integrity";
    private const string CurrentVersion = "0.741.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("[x] `STATE-001` Backend test suite проходит: `1575/1575`.", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-473`", roadmap, StringComparison.Ordinal);
        ...
        Assert.Contains("[x] `STATE-002` Frontend test suite проходит: `193/193`.", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("1575/1575", readme, StringComparison.Ordinal);
        Assert.Contains("1575/1575", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("1575/1575", releaseDecision, StringComparison.Ordinal);
