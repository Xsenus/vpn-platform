...
{
    private const string CurrentReleaseId = "2026-08-12-paypal-approved-order-capture";
    private const string CurrentVersion = "0.661.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("[x] `STATE-001` Backend test suite проходит: `1304/1304`.", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("1304/1304", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("1304/1304", releaseDecision, StringComparison.Ordinal);
