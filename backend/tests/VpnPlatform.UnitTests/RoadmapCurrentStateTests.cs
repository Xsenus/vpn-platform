...
{
    private const string CurrentReleaseId = "2026-06-18-production-readiness-assertion-ci-regression";
    private const string CurrentVersion = "0.159.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("545/545", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("545/545", readme, StringComparison.Ordinal);
        Assert.Contains("545/545", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("545/545", releaseDecision, StringComparison.Ordinal);
