...
{
    private const string CurrentReleaseId = "2026-08-10-public-route-metadata-focus-fix";
    private const string CurrentVersion = "0.568.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("115/115", roadmap, StringComparison.Ordinal);
