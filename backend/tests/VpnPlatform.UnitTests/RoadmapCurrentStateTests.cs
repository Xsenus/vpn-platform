...
{
    private const string CurrentReleaseId = "2026-08-05-payment-checkout-account-selection";
    private const string CurrentVersion = "0.484.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("983/983", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("983/983", readme, StringComparison.Ordinal);
        Assert.Contains("983/983", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("983/983", releaseDecision, StringComparison.Ordinal);
