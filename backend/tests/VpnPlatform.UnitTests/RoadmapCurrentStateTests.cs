...
{
    private const string CurrentReleaseId = "2026-07-02-payment-provider-smoke-report-self-link";
    private const string CurrentVersion = "0.407.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("702/702", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("702/702", readme, StringComparison.Ordinal);
        Assert.Contains("702/702", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("702/702", releaseDecision, StringComparison.Ordinal);
