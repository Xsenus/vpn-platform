...
{
    private const string CurrentReleaseId = "2026-08-12-provisioning-inventory-argument-guard";
    private const string CurrentVersion = "0.647.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("[x] `STATE-001` Backend test suite проходит: `1211/1211`.", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `STATE-002` Frontend test suite проходит: `139/139`.", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("1211/1211", readme, StringComparison.Ordinal);
        Assert.Contains("1211/1211", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("1211/1211", releaseDecision, StringComparison.Ordinal);
