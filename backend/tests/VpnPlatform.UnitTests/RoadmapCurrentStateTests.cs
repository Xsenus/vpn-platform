...
{
    private const string CurrentReleaseId = "2026-08-05-cabinet-renewal-status-guard";
    private const string CurrentVersion = "0.487.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("986/986", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `STATE-002`", roadmap, StringComparison.Ordinal);
        Assert.Contains("69/69", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("986/986", readme, StringComparison.Ordinal);
        Assert.Contains("986/986", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("986/986", releaseDecision, StringComparison.Ordinal);
