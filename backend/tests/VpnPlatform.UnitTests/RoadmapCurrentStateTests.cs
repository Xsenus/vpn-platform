...
{
    private const string CurrentReleaseId = "2026-06-18-production-readiness-assertion-result-artifacts";
    private const string CurrentVersion = "0.156.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("542/542", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("542/542", readme, StringComparison.Ordinal);
        Assert.Contains("542/542", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("542/542", releaseDecision, StringComparison.Ordinal);
