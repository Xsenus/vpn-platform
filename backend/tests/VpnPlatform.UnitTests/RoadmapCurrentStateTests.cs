...
{
    private const string CurrentReleaseId = "2026-08-12-payment-status-proof-boundary";
    private const string CurrentVersion = "0.662.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("[x] `STATE-001` Backend test suite проходит: `1316/1316`.", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `P11-ACC-384`", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `STATE-002` Frontend test suite проходит: `144/144`.", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("1316/1316", readme, StringComparison.Ordinal);
        Assert.Contains("1316/1316", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("1316/1316", releaseDecision, StringComparison.Ordinal);
