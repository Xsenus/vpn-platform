...
{
    private const string CurrentReleaseId = "2026-06-18-production-evidence-handoff-package-archive-flow-result-validator-regression";
    private const string CurrentVersion = "0.147.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("533/533", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("533/533", readme, StringComparison.Ordinal);
        Assert.Contains("533/533", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("533/533", releaseDecision, StringComparison.Ordinal);
