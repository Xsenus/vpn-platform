...
{
    private const string CurrentReleaseId = "2026-07-02-agent-duplicate-task-guard";
    private const string CurrentVersion = "0.448.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("731/731", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("731/731", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("731/731", releaseDecision, StringComparison.Ordinal);
