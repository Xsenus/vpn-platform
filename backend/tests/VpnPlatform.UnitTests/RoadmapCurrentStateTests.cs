...
{
    private const string CurrentReleaseId = "2026-08-05-referral-reward-lifecycle";
    private const string CurrentVersion = "0.517.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("1087/1087", roadmap, StringComparison.Ordinal);
        Assert.Contains("[x] `STATE-002`", roadmap, StringComparison.Ordinal);
        Assert.Contains("89/89", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("1087/1087", readme, StringComparison.Ordinal);
        Assert.Contains("1087/1087", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("1087/1087", releaseDecision, StringComparison.Ordinal);
