...
{
    private const string CurrentReleaseId = "2026-08-09-public-checkout-storage-validation";
    private const string CurrentVersion = "0.543.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("107/107", roadmap, StringComparison.Ordinal);
