...
{
    private const string CurrentReleaseId = "2026-06-23-admin-bootstrap-readiness-password-env-validator";
    private const string CurrentVersion = "0.288.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("592/592", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("592/592", readme, StringComparison.Ordinal);
        Assert.Contains("592/592", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("592/592", releaseDecision, StringComparison.Ordinal);
