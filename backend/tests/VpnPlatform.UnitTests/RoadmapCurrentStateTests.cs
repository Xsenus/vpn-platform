...
{
    private const string CurrentReleaseId = "2026-06-19-admin-vps-smoke-preflight-validator-regression";
    private const string CurrentVersion = "0.188.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("579/579", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("579/579", readme, StringComparison.Ordinal);
        Assert.Contains("579/579", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("579/579", releaseDecision, StringComparison.Ordinal);
