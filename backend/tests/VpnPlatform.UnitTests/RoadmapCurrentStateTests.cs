...
{
    private const string CurrentReleaseId = "2026-08-11-admin-managed-config-resource-owner";
    private const string CurrentVersion = "0.623.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("[x] `STATE-002` Frontend test suite проходит: `127/127`.", roadmap, StringComparison.Ordinal);
