...
{
    private const string CurrentReleaseId = "2026-08-09-admin-mutation-request-lifecycle";
    private const string CurrentVersion = "0.549.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("[x] `P11-ACC-272`", roadmap, StringComparison.Ordinal);
