...
{
    private const string CurrentReleaseId = "2026-08-09-vpn-panel-api-dto-validation";
    private const string CurrentVersion = "0.534.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("101/101", roadmap, StringComparison.Ordinal);
