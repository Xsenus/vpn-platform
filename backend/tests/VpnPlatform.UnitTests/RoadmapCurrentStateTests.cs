...
{
    private const string CurrentReleaseId = "2026-06-19-production-ci-workflow-artifacts-guards-ci-step-guard";
    private const string CurrentVersion = "0.175.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("561/561", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("561/561", readme, StringComparison.Ordinal);
        Assert.Contains("561/561", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("561/561", releaseDecision, StringComparison.Ordinal);
