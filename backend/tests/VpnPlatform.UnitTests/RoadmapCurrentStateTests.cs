...
{
    private const string CurrentReleaseId = "2026-08-13-sqlite-outbox-provisioning-temporal-preflight";
    private const string CurrentVersion = "0.709.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("[x] `STATE-001` Backend test suite проходит: `1490/1490`.", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("1490/1490", readme, StringComparison.Ordinal);
        Assert.Contains("1490/1490", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("1490/1490", releaseDecision, StringComparison.Ordinal);
