...
{
    private const string CurrentReleaseId = "2026-08-05-qr-svg-render-boundary";
    private const string CurrentVersion = "0.523.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("94/94", roadmap, StringComparison.Ordinal);
