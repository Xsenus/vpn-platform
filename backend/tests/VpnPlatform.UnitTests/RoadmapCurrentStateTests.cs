...
{
    private const string CurrentReleaseId = "2026-07-02-agent-git-delivery-guard";
    private const string CurrentVersion = "0.446.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("729/729", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("729/729", readme, StringComparison.Ordinal);
        Assert.Contains("729/729", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("729/729", releaseDecision, StringComparison.Ordinal);
