...
{
    private const string CurrentReleaseId = "2026-06-14-staging-smoke-report-consistency";
    private const string CurrentVersion = "0.114.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("488/488", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("488/488", readme, StringComparison.Ordinal);
        Assert.Contains("488/488", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("488/488", releaseDecision, StringComparison.Ordinal);
