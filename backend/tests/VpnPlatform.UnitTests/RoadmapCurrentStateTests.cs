...
{
    private const string CurrentReleaseId = "2026-07-01-production-handoff-ci-result-latest-release-guard-cleanup";
    private const string CurrentVersion = "0.361.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("656/656", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("656/656", readme, StringComparison.Ordinal);
        Assert.Contains("656/656", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("656/656", releaseDecision, StringComparison.Ordinal);
