...
{
    private const string CurrentReleaseId = "2026-06-22-local-admin-bootstrap-smoke-explicit-max-duration-guard";
    private const string CurrentVersion = "0.260.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("591/591", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("591/591", readme, StringComparison.Ordinal);
        Assert.Contains("591/591", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("591/591", releaseDecision, StringComparison.Ordinal);
