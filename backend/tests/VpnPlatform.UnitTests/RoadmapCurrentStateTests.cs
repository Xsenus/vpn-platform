...
{
    private const string CurrentReleaseId = "2026-07-02-production-handoff-receipt-markdown-verified-files-guard-cleanup";
    private const string CurrentVersion = "0.373.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("668/668", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("668/668", readme, StringComparison.Ordinal);
        Assert.Contains("668/668", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("668/668", releaseDecision, StringComparison.Ordinal);
