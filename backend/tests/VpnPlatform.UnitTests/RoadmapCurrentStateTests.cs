...
{
    private const string CurrentReleaseId = "2026-07-02-admin-vps-smoke-preflight-validator-cleanup";
    private const string CurrentVersion = "0.388.0";
    ...
    public void Roadmap_Current_State_Should_Match_Latest_Local_Evidence()
    {
        ...
        Assert.Contains("683/683", roadmap, StringComparison.Ordinal);
    ...
    public void Current_State_Should_Be_Linked_From_Docs_Changelog_Test_Results_And_Release_Seed()
    {
        ...
        Assert.Contains("683/683", readme, StringComparison.Ordinal);
        Assert.Contains("683/683", finalRunbook, StringComparison.Ordinal);
        Assert.Contains("683/683", releaseDecision, StringComparison.Ordinal);
