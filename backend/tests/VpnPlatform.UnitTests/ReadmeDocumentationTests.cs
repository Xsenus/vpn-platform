...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("133/133", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-12-public-pending-checkout-live-expiry", readme, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("212/212", readme, StringComparison.Ordinal);
    }
