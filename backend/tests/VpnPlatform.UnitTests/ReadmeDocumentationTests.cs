...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("473/473", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-06-14-vps-production-smoke-runner", readme, StringComparison.OrdinalIgnoreCase);
    }
