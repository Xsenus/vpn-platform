...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("179/179", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-14-admin-user-vpn-label-localization", readme, StringComparison.OrdinalIgnoreCase);
