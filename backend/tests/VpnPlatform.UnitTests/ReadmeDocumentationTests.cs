...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("2026-08-11-admin-concurrent-busy-resource-owner", readme, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("184/184", readme, StringComparison.Ordinal);
    }
