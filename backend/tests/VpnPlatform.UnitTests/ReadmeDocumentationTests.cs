...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("171/171", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-13-vpn-panel-management-boundary", readme, StringComparison.OrdinalIgnoreCase);
    ...
    public void Readme_Should_Keep_Current_External_Evidence_Status_Explicit()
    {
        ...
        foreach (var expected in new[]
                 {
                     "1444/1444",
                     "2026-08-13-vpn-panel-management-boundary",
                     "0.681.0",
