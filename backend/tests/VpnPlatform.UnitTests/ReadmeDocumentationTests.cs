...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("193/193", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-15-server-editor-noop-draft-integrity", readme, StringComparison.OrdinalIgnoreCase);
    ...
    public void Readme_Should_Keep_Current_External_Evidence_Status_Explicit()
    {
        ...
        foreach (var expected in new[]
                 {
                     "1575/1575",
                     "2026-08-15-server-editor-noop-draft-integrity",
                     "0.741.0",
