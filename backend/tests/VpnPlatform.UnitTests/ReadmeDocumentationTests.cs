...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("100/100", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-09-admin-content-api-dto-validation", readme, StringComparison.OrdinalIgnoreCase);
    }
