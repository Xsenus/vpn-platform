...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("2026-08-11-public-checkout-session-boundary", readme, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("156/156", readme, StringComparison.Ordinal);
    }
