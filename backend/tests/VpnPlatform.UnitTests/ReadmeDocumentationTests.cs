...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("71/71", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-05-cabinet-logout-failure-cleanup", readme, StringComparison.OrdinalIgnoreCase);
    }
