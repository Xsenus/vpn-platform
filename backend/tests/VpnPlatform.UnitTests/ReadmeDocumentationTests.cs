...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("125/125", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-11-cabinet-data-reload-single-flight", readme, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("166/166", readme, StringComparison.Ordinal);
    }
