...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("139/139", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-12-provisioning-inventory-argument-guard", readme, StringComparison.OrdinalIgnoreCase);
