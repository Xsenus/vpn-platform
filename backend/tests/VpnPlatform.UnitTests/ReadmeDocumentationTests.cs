...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("2026-08-11-public-managed-content-load-lifecycle", readme, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("164/164", readme, StringComparison.Ordinal);
    }
