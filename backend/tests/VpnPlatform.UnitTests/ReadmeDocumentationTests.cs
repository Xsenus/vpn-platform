...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("191/191", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-15-admin-conflict-draft-recovery", readme, StringComparison.OrdinalIgnoreCase);
    ...
    public void Readme_Should_Keep_Current_External_Evidence_Status_Explicit()
    {
        ...
        foreach (var expected in new[]
                 {
                     "1574/1574",
                     "2026-08-15-admin-conflict-draft-recovery",
                     "0.740.0",
