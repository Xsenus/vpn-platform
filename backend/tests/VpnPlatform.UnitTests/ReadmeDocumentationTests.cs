...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("127/127", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-11-admin-managed-config-resource-owner", readme, StringComparison.OrdinalIgnoreCase);
