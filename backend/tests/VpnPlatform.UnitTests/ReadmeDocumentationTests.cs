...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("102/102", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-09-admin-infrastructure-api-dto-validation", readme, StringComparison.OrdinalIgnoreCase);
    }
