...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("159/159", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-13-admin-referral-program-boundary", readme, StringComparison.OrdinalIgnoreCase);
