...
public class ReadmeDocumentationTests
{
    ...
    public void Readme_Should_Expose_Current_Validation_Commands_And_Status()
    {
        ...
        Assert.Contains("177/177", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("2026-08-14-russian-date-and-status-localization", readme, StringComparison.OrdinalIgnoreCase);
