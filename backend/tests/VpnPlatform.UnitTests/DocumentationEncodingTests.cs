...
public class DocumentationEncodingTests
{
    ...
    [Fact]
    public void Agent_Instructions_Should_Require_End_To_End_Task_Completion()
    {
        var root = FindRepositoryRoot();
        var instructions = File.ReadAllText(Path.Combine(root, "AGENTS.md"));
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "\u0434\u043E\u0432\u043E\u0434\u0438\u0442\u044C \u0437\u0430\u0434\u0430\u0447\u0443 \u043E\u0442 \u043D\u0430\u0447\u0430\u043B\u0430 \u0434\u043E \u043A\u043E\u043D\u0446\u0430",
                     "\u0430\u043D\u0430\u043B\u0438\u0437",
                     "\u043A\u043E\u0434",
                     "\u0442\u0435\u0441\u0442\u044B",
                     "\u043B\u043E\u043A\u0430\u043B\u044C\u043D\u0430\u044F \u0411\u0414/SQLite",
                     ...
                     "\u0440\u0435\u0430\u043B\u044C\u043D\u043E\u0433\u043E \u0431\u043B\u043E\u043A\u0435\u0440\u0430",
                     "\u0437\u0430\u043A\u0440\u044B\u0432\u0430\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u043D\u0435\u0434\u043E\u0441\u0442\u0430\u044E\u0449\u0443\u044E \u0447\u0430\u0441\u0442\u044C"
                 })
        {
            Assert.Contains(expected, instructions, StringComparison.OrdinalIgnoreCase);
        }
    ...
    [Fact]
    public void Agent_Instructions_Should_Keep_External_Evidence_Items_Open_Without_Real_Evidence()
    {
        var root = FindRepositoryRoot();
        var instructions = File.ReadAllText(Path.Combine(root, "AGENTS.md"));
        ...
        foreach (var expected in new[]
                 {
                     ...
                     "production-like VPN",
                     "3x-ui/x-ui",
                     "\u0432\u043D\u0435\u0448\u043D\u0438\u0435 provider \u043A\u0430\u0431\u0438\u043D\u0435\u0442\u044B",
                     "\u043D\u0435\u043B\u044C\u0437\u044F \u0437\u0430\u043A\u0440\u044B\u0432\u0430\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u043B\u043E\u043A\u0430\u043B\u044C\u043D\u044B\u043C\u0438 \u0442\u0435\u0441\u0442\u0430\u043C\u0438",
                     "\u043C\u043E\u043A\u0430\u043C\u0438",
                     "dry-run",
                     "SQLite smoke",
                     "\u043B\u043E\u043A\u0430\u043B\u044C\u043D\u044B\u0435 \u043F\u0440\u043E\u0432\u0435\u0440\u043A\u0438 \u043C\u043E\u0436\u043D\u043E \u0438\u0441\u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u043A\u0430\u043A \u043F\u043E\u0434\u0433\u043E\u0442\u043E\u0432\u043A\u0443",
                     "\u0441\u0442\u0430\u0442\u0443\u0441 `[x]` \u0434\u043E\u043F\u0443\u0441\u0442\u0438\u043C \u0442\u043E\u043B\u044C\u043A\u043E \u043F\u043E\u0441\u043B\u0435 \u0440\u0435\u0430\u043B\u044C\u043D\u043E\u0433\u043E evidence",
                     "\u043E\u0441\u0442\u0430\u0432\u043B\u044F\u0442\u044C \u043F\u0443\u043D\u043A\u0442 \u043E\u0442\u043A\u0440\u044B\u0442\u044B\u043C \u0438\u043B\u0438 `[~]`",
                     "\u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u043D\u0443\u044E \u043F\u0440\u043E\u0432\u0435\u0440\u043A\u0443",
                     "\u043E\u0441\u0442\u0430\u0442\u043E\u0447\u043D\u044B\u0439 \u0440\u0438\u0441\u043A"
                 })
        {
            Assert.Contains(expected, instructions, StringComparison.OrdinalIgnoreCase);
