...
public class SecurityFinalChecklistTests
{
    ...
    public void Security_Final_Checklist_Should_Link_Guards_And_Current_Evidence()
    {
        ...
        Assert.Contains("1229/1229", checklist, StringComparison.Ordinal);
        Assert.Contains("2026-08-12-vpn-public-endpoint-protocol-guard", checklist, StringComparison.OrdinalIgnoreCase);
