...
public class SecurityFinalChecklistTests
{
    ...
    public void Security_Final_Checklist_Should_Link_Guards_And_Current_Evidence()
    {
        ...
        Assert.Contains("1112/1112", checklist, StringComparison.Ordinal);
        Assert.Contains("2026-08-09-admin-subscription-access-action-api-dto-validation", checklist, StringComparison.OrdinalIgnoreCase);
