...
public class SecurityFinalChecklistTests
{
    ...
    public void Security_Final_Checklist_Should_Link_Guards_And_Current_Evidence()
    {
        ...
        Assert.Contains("1146/1146", checklist, StringComparison.Ordinal);
        Assert.Contains("2026-08-12-access-sync-read-failure", checklist, StringComparison.OrdinalIgnoreCase);
