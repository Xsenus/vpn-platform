...
public class SecurityFinalChecklistTests
{
    ...
    public void Security_Final_Checklist_Should_Link_Guards_And_Current_Evidence()
    {
        ...
        Assert.Contains("1059/1059", checklist, StringComparison.Ordinal);
        Assert.Contains("2026-08-05-support-conversation-concurrency", checklist, StringComparison.OrdinalIgnoreCase);
