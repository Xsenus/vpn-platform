...
public class SecurityFinalChecklistTests
{
    ...
    public void Security_Final_Checklist_Should_Link_Guards_And_Current_Evidence()
    {
        ...
        Assert.Contains("1125/1125", checklist, StringComparison.Ordinal);
        Assert.Contains("2026-08-11-admin-subscription-access-resource-owner", checklist, StringComparison.OrdinalIgnoreCase);
