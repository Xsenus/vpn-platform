...
public class SecurityFinalChecklistTests
{
    ...
    public void Security_Final_Checklist_Should_Link_Guards_And_Current_Evidence()
    {
        ...
        Assert.Contains("1144/1144", checklist, StringComparison.Ordinal);
        Assert.Contains("2026-08-12-access-sync-reset-persistence", checklist, StringComparison.OrdinalIgnoreCase);
