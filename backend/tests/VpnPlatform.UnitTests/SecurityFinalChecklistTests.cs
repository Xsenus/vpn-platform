...
public class SecurityFinalChecklistTests
{
    ...
    public void Security_Final_Checklist_Should_Link_Guards_And_Current_Evidence()
    {
        ...
        Assert.Contains("873/873", checklist, StringComparison.Ordinal);
        Assert.Contains("2026-08-04-telegram-notification-dispatch-recovery", checklist, StringComparison.OrdinalIgnoreCase);
