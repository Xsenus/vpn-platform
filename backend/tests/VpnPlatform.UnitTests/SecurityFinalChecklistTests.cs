...
public class SecurityFinalChecklistTests
{
    ...
    public void Security_Final_Checklist_Should_Link_Guards_And_Current_Evidence()
    {
        ...
        Assert.Contains("1061/1061", checklist, StringComparison.Ordinal);
        Assert.Contains("2026-08-05-provisioning-cancel-claim-boundary", checklist, StringComparison.OrdinalIgnoreCase);
