...
public class SecurityFinalChecklistTests
{
    ...
    public void Security_Final_Checklist_Should_Link_Guards_And_Current_Evidence()
    {
        ...
        Assert.Contains("1211/1211", checklist, StringComparison.Ordinal);
        Assert.Contains("2026-08-12-provisioning-inventory-argument-guard", checklist, StringComparison.OrdinalIgnoreCase);
