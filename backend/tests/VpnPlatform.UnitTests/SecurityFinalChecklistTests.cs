...
public class SecurityFinalChecklistTests
{
    ...
    public void Security_Final_Checklist_Should_Link_Guards_And_Current_Evidence()
    {
        ...
        Assert.Contains("1255/1255", checklist, StringComparison.Ordinal);
        Assert.Contains("2026-08-12-payment-local-sandbox-refund-contract", checklist, StringComparison.OrdinalIgnoreCase);
