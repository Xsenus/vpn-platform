...
public class SecurityFinalChecklistTests
{
    ...
    public void Security_Final_Checklist_Should_Link_Guards_And_Current_Evidence()
    {
        ...
        Assert.Contains("954/954", checklist, StringComparison.Ordinal);
        Assert.Contains("2026-08-04-x3ui-client-migration-atomicity", checklist, StringComparison.OrdinalIgnoreCase);
