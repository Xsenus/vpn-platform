...
public class SecurityFinalChecklistTests
{
    ...
    public void Security_Final_Checklist_Should_Link_Guards_And_Current_Evidence()
    {
        ...
        Assert.Contains("1043/1043", checklist, StringComparison.Ordinal);
        Assert.Contains("2026-08-05-refresh-token-rotation-concurrency", checklist, StringComparison.OrdinalIgnoreCase);
