...
is_skipped_path() {
  ...
  case "$path" in
    .git/*|.serena/*|.playwright-mcp/*|*/node_modules/*|node_modules/*|*/bin/*|bin/*|*/obj/*|obj/*|*/dist/*|dist/*|*/build/*|build/*|*/TestResults/*|TestResults/*|*/test-results/*|test-results/*|*/tmp/*|tmp/*|*/.playwright-artifacts-*/*|.playwright-artifacts-*/*|*/artifacts/*|artifacts/*|*/coverage/*|coverage/*|*/playwright-report/*|playwright-report/*|*/backups/*|backups/*)
      return 0
      ;;
  esac
  return 1
