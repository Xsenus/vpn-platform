...
- `npm run e2e:console --prefix frontend`: `158/158`; all-screens: `6/6`.
...
- Latest "Что нового": `2026-08-11-public-catalog-load-recovery`, версия `0.606.0`; public tariffs/payment providers используют независимые recovery-state без false empty, а полный browser gate проходит `158/158` без failed/flaky/skipped.
