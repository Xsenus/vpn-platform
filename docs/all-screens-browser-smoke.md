...
- `npm run e2e:console --prefix frontend`: `140/140`; all-screens: `6/6`.
...
- Latest "Что нового": `2026-08-11-cabinet-support-messages-retry`, версия `0.597.0`; ошибка загрузки сообщений остаётся в выбранной переписке, false empty state скрыт, explicit retry восстанавливает сообщения, а полный browser gate проходит `140/140`.
