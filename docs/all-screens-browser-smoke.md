...
- Latest "Что нового": `2026-08-12-provider-refund-payload-recovery`, версия `0.659.0`; полный browser inventory остаётся `227/227` за `15.0 min` без failed/flaky/skipped.
