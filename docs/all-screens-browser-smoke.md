...
- Latest "Что нового": `2026-08-11-public-checkout-session-expiry`, версия `0.631.0`; истёкшая checkout-session блокируется до claim и не предлагает retry, а финальный полный browser gate проходит `200/200` без failed/flaky/skipped.
