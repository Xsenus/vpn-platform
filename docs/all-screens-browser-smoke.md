...
- `npm run e2e:console --prefix frontend`: `142/142`; all-screens: `6/6`.
...
- Latest "Что нового": `2026-08-11-admin-support-messages-retry`, версия `0.598.0`; ошибка загрузки сообщений остаётся в карточке admin-диалога, false empty state скрыт, explicit retry восстанавливает переписку, а полный browser gate проходит `142/142`.
