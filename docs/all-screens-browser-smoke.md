...
- `npm run e2e:console --prefix frontend`: `146/146`; all-screens: `6/6`.
...
- Latest "Что нового": `2026-08-11-admin-detail-recovery`, версия `0.599.0`; ошибки карточки пользователя и деталей VPN-панели остаются scoped, contradictory selection/empty content скрыт, explicit retry восстанавливает выбранные данные, а полный browser gate проходит `146/146` без failed/flaky/skipped.
