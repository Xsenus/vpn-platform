...
- Latest "Что нового": `2026-08-24-live-vps-partial-evidence`, версия `0.752.0`; frontend baseline не менялся, desktop/mobile и полная responsive-матрица `282/282` проходят, а real VPS public/cabinet/admin load дал `console error=0`.
