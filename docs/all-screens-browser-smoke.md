...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `278/278` за `12.6 min`, frontend `187/187`, production build и admin bundle budget raw `580740/581632`, gzip `154568/154624` зелёные.
...
- Latest "Что нового": `2026-08-15-vpn-editor-noop-draft-integrity`, версия `0.738.0`; panel/inbound no-op до remote mutation и delayed stale-conflict draft integrity проверены на desktop/mobile и полной responsive-матрице без invalid geometry или diagnostics.
