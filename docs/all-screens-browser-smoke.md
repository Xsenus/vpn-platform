...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `276/276`, frontend `184/184`, production build и admin bundle budget raw `576571/577536`, gzip `153129/153600` зелёные.
...
- Latest "Что нового": `2026-08-15-managed-editor-draft-integrity`, версия `0.736.0`; FAQ/content/scenario no-op и delayed stale-conflict draft integrity проверены на desktop/mobile и полной responsive-матрице без invalid geometry или diagnostics.
