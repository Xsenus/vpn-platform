...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `276/276` за `13.0 min`, frontend `185/185`, production build и admin bundle budget raw `579420/580608`, gzip `154073/154624` зелёные.
...
- Latest "Что нового": `2026-08-15-commercial-editor-noop-integrity`, версия `0.737.0`; tariff/referral/release no-op и delayed tariff stale-conflict draft integrity проверены на desktop/mobile и полной responsive-матрице без invalid geometry или diagnostics.
