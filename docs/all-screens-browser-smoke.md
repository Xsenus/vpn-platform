...
- `npm run e2e:console --prefix frontend`: `132/132`; all-screens: `6/6`.
...
- Latest "Что нового": `2026-08-11-cabinet-app-version-manual-intent`, версия `0.593.0`; manual open signal ждёт profile ID при активном token, сбрасывается на logout, а полный browser gate проходит `132/132`.
