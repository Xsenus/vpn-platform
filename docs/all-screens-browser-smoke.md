...
- Latest "Что нового": `2026-08-12-access-revision-sequence`, версия `0.641.0`; backend выравнивает revision durable access mutations, UI не менялся, а актуальный полный browser inventory проходит `218/218` без failed/flaky/skipped.
