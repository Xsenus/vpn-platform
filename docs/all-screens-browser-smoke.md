...
- `npm run e2e:console --prefix frontend`: `130/130`; all-screens: `6/6`.
...
- Latest "Что нового": `2026-08-11-cabinet-app-version-identity-boundary`, версия `0.592.0`; cabinet ждёт profile ID перед latest request, применяет user-specific dismissal без anonymous fallback, а полный browser gate проходит `130/130`.
