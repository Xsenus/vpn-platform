...
- Latest "Что нового": `2026-08-24-deploy-production-smtp-preflight`, версия `0.751.0`; frontend baseline не менялся, desktop/mobile и полная responsive-матрица `282/282` проходят без invalid geometry.
