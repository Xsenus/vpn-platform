...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `282/282` за `13.0 min`, frontend `196/196`, production build и admin bundle budget raw `586628/586752`, gzip `156120/156672` зелёные.
...
- Latest "Что нового": `2026-08-15-server-archive-readonly`, версия `0.747.0`; archived VPN server сохраняет historical diagnostics без mutation controls, а direct health блокируется до local churn; desktop/mobile и полная responsive-матрица проходят без invalid geometry.
