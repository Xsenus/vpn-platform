...
- Latest "Что нового": `2026-08-12-server-payload-validation`, версия `0.643.0`; backend server payload validation усилена без изменения UI, а актуальный полный browser inventory проходит `218/218` без failed/flaky/skipped.
