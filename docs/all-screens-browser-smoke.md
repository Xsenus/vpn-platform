...
- Latest "Что нового": `2026-08-24-production-email-degraded-mode`, версия `0.753.0`; frontend baseline остаётся `197/197`, desktop/mobile responsive-матрица `282/282` проходит, а degraded password-reset error локализован для кабинета.
