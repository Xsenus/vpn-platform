...
- Latest "Что нового": `2026-08-11-public-catalog-load-single-flight`, версия `0.616.0`; initial/retry загрузки public tariffs/payment providers имеют component-scoped claims, in-flight и generation guards и не дублируются под StrictMode, а полный browser gate проходит `172/172` без failed/flaky/skipped.
