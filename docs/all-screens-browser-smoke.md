...
- Latest "Что нового": `2026-08-31-production-vpn-panel-smoke`, версия `0.756.0`; frontend baseline остаётся `197/197`, полный изменённый all-screens responsive-прогон проходит `14/14` за `16.4 min`, production admin smoke прошел `17/17` sections, real 3x-ui panel/inbound checks `2/2`.
