...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `282/282` за `12.9 min`, frontend `191/191`, production build и admin bundle budget raw `583299/583680`, gzip `155189/155648` зелёные.
...
- Latest "Что нового": `2026-08-15-admin-conflict-draft-recovery`, версия `0.740.0`; payment/tariff/referral/release/VPN draft rebase и retry проверены на desktop/mobile и полной responsive-матрице без invalid geometry или diagnostics.
