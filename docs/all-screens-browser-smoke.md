...
- Latest "Что нового": `2026-08-12-access-sync-read-failure`, версия `0.640.0`; backend usage read failure сохраняет фактический access state, UI не менялся, а актуальный полный browser inventory проходит `218/218` без failed/flaky/skipped.
