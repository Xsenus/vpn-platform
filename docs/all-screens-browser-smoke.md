...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `276/276`, frontend `183/183`, production build и admin bundle budget raw `573846/574464`, gzip `152397/152576` зелёные.
...
- Latest "Что нового": `2026-08-15-telegram-settings-versioned-management`, версия `0.735.0`; versioned Telegram settings, блокировка no-op save и восстановление после stale conflict проверены на desktop/mobile, реальной локальной админке и полной responsive-матрице без invalid geometry или diagnostics.
