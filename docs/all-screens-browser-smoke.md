...
- `npm run e2e:console --prefix frontend`: `128/128`; all-screens: `6/6`.
...
- Latest "Что нового": `2026-08-11-cabinet-app-version-session-boundary`, версия `0.591.0`; cabinet latest/history requests принадлежат текущей token/user generation, stale completions после logout/login отклоняются, а полный browser gate проходит `128/128`.
