...
- Latest "Что нового": `2026-08-15-server-archive-noop-integrity`, версия `0.743.0`; архивная VPN server card сохраняет diagnostics без повторного delete-action на desktop/mobile и полной responsive-матрице без invalid geometry или diagnostics.
