...
- Latest "Что нового": `2026-08-12-access-lifecycle-fail-closed`, версия `0.642.0`; admin direct access actions завершаются ранним `503` без lifecycle-сервиса, UI не менялся, а актуальный полный browser inventory проходит `218/218` без failed/flaky/skipped.
