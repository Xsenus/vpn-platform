...
- Latest "Что нового": `2026-08-11-cabinet-restored-data-boundary`, версия `0.600.0`; failed restored-session load не показывает ложные aggregate/private empty states, explicit retry сохраняет сессию и восстанавливает данные, а полный browser gate проходит `146/146` без failed/flaky/skipped.
