...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `282/282` за `13.2 min`, frontend `195/195`, production build и admin bundle budget raw `586228/586752`, gzip `155984/156672` зелёные.
...
- Latest "Что нового": `2026-08-15-server-state-transition-integrity`, версия `0.742.0`; допустимые VPN server state-actions и отсутствие resurrection-переходов проверены на desktop/mobile и полной responsive-матрице без invalid geometry или diagnostics.
