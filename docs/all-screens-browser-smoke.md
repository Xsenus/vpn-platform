...
- Latest "Что нового": `2026-08-11-cabinet-recovery-load-single-flight`, версия `0.615.0`; payment-provider discovery и messages retry кабинета имеют session/token/scope-scoped Promise owners и не дублируют synchronous activation, а полный browser gate проходит `172/172` без failed/flaky/skipped.
