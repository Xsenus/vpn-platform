...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `280/280` за `12.6 min`, frontend `189/189`, production build и admin bundle budget raw `582209/582656`, gzip `154904/155648` зелёные.
...
- Latest "Что нового": `2026-08-15-payment-provider-concurrency-integrity`, версия `0.739.0`; payment-provider revision/no-op и delayed stale-conflict draft integrity проверены на desktop/mobile и полной responsive-матрице без invalid geometry или diagnostics.
