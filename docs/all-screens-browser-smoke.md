...
- `npm run e2e:console --prefix frontend`: `108/108`; all-screens: `6/6`.
...
- Admin production build содержит `5` JS chunks под fail-closed budget: raw `512423`, gzip `137489`, largest `219849` bytes.
