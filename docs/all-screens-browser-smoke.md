...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `282/282` за `13.0 min`, frontend `193/193`, production build и admin bundle budget raw `585800/586752`, gzip `155817/156672` зелёные.
...
- Latest "Что нового": `2026-08-15-server-editor-noop-draft-integrity`, версия `0.741.0`; VPN-server no-op и новый draft после delayed conflict проверены на desktop/mobile и полной responsive-матрице без invalid geometry или diagnostics.
