...
- `npm run e2e:console --prefix frontend`: `124/124`; all-screens: `6/6`.
...
- Latest "Что нового": `2026-08-11-runtime-error-ui-boundary`, версия `0.589.0`; public/cabinet/admin скрывают API, network, runtime и handler diagnostics за контекстным русским fallback; session/provider/renewal/action/load paths проверены на desktop/mobile.
