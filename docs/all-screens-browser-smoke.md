...
- Latest "Что нового": `2026-08-31-production-admin-and-threexui-api-token`, версия `0.755.0`; frontend baseline остаётся `197/197`, полный изменённый all-screens responsive-прогон проходит `14/14` за `16.4 min`, production admin smoke прошел `17/17` sections.
