...
- `npm run e2e:console --prefix frontend`: `134/134`; all-screens: `6/6`.
...
- Latest "Что нового": `2026-08-11-cabinet-app-version-history-retry`, версия `0.594.0`; failed/empty history завершается одной attempt, recovery запускается явным retry, а полный browser gate проходит `134/134`.
