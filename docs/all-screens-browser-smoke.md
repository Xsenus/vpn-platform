...
- Latest "Что нового": `2026-08-24-controlled-production-database-migrations`, версия `0.754.0`; frontend baseline остаётся `197/197`, desktop/mobile responsive-матрица `282/282` проходит, а deployment-only backup/migration path не меняет UI.
