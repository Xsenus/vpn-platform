...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `282/282` за `13.1 min`, frontend `196/196`, production build и admin bundle budget raw `586612/586752`, gzip `156122/156672` зелёные.
...
- Latest "Что нового": `2026-08-15-vpn-panel-archive-operational-readonly`, версия `0.746.0`; archived 3x-ui details сохраняют diagnostic history, а direct health/test/sync блокируются до side effects; desktop/mobile и полная responsive-матрица проходят без invalid geometry.
