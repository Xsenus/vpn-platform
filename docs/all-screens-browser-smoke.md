...
- Latest "Что нового": `2026-08-11-admin-concurrent-busy-resource-owner`, версия `0.624.0`; все admin mutation indicators используют multi-owner resource busy-state и не разблокируются от завершения независимой команды, а полный browser gate проходит `184/184` без failed/flaky/skipped.
