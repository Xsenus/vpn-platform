...
- `npm run e2e:console --prefix frontend`: `126/126`; all-screens: `6/6`.
...
- Latest "Что нового": `2026-08-11-public-managed-error-content`, версия `0.590.0`; delayed CMS content обновляет managed tariff/provider load errors, а exhaustive admin matrix имеет измеренный `600 s` timeout без сокращения 25 viewport или layout/WCAG coverage.
