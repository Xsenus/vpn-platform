...
- Latest "Что нового": `2026-08-12-payment-refund-capability-preflight`, версия `0.651.0`; изменение ограничено backend refund orchestration, UI/DTO не менялись, актуальный полный browser inventory проходит `220/220` за `13.6 min` без failed/flaky/skipped.
