...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `282/282` за `13.4 min`, frontend `196/196`, production build и admin bundle budget raw `586612/586752`, gzip `156122/156672` зелёные.
...
- Latest "Что нового": `2026-08-15-vpn-panel-archive-readonly`, версия `0.745.0`; archived 3x-ui details сохраняют inbound/client/diagnostic history без форм и child actions на desktop/mobile и полной responsive-матрице без invalid geometry.
