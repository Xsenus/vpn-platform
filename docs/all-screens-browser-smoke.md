...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `282/282` за `13.4 min`, frontend `197/197`, production build и admin bundle budget raw `586693/586752`, gzip `156177/156672` зелёные.
...
- Latest "Что нового": `2026-08-15-server-archive-active-workload-guard`, версия `0.749.0`; occupied VPN server не показывает delete, active workload блокирует archive, а free historical server сохраняет рабочий archive flow; desktop/mobile и полная responsive-матрица проходят без invalid geometry.
