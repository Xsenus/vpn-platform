...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `282/282` за `19.5 min`, frontend `197/197`, production build и admin bundle budget raw `586719/586752`, gzip `156170/156672` зелёные.
...
- Latest "Что нового": `2026-08-24-maintenance-and-mobile-heading-guard`, версия `0.750.0`; maintenance exit оставляет allocation закрытым, а mobile hero word integrity проверяется через DOM Range; desktop/mobile и полная responsive-матрица проходят без invalid geometry.
