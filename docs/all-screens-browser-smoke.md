...
- Полный Playwright public/cabinet/admin/all-screens/mobile/console `274/274`, frontend `182/182`, production build и admin bundle budget raw `572159/573440`, gzip `152028/152576` зелёные.
...
- Latest "Что нового": `2026-08-15-admin-user-versioned-management`, версия `0.734.0`; редактор пользователя, подтверждение завершения сессий и восстановление после stale conflict проверены на desktop/mobile и полной responsive-матрице, users screenshots просмотрены без invalid geometry или diagnostics.
