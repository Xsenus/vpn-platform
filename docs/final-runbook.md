...
- latest "Что нового": `2026-08-11-admin-detail-retry-single-flight`, версия `0.613.0`; admin detail loaders возвращают duplicate caller текущий Promise для user overview, support messages и VPN panel details.
