...
- latest "Что нового": `2026-08-13-admin-support-read-boundary`, версия `0.686.0`; admin support conversations/messages применяют latest top-200 в БД и сохраняют хронологический порядок сообщений.
