...
- browser console smoke: 156/156; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-public-checkout-session-boundary`, версия `0.605.0`; public session cleanup удаляет checkout result, order/payment IDs, redirect URL и order-bearing diagnostics до следующего login.
- roadmap progress: `618/638` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
