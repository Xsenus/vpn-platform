...
- browser console smoke: 174/174; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-admin-support-mutation-resource-owner`, версия `0.619.0`; status/reply/internal note одного admin support conversation используют общий identity-safe resource owner, shared busy-state и последовательные optimistic revisions.
- roadmap progress: `632/652` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
