...
- latest "Что нового": `2026-08-13-delivery-dispatch-query-boundary`, версия `0.698.0`; SQLite delivery queues применяют due/stale window и limit в БД.
- roadmap progress: `711/731` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
