...
- latest "Что нового": `2026-08-12-access-lifecycle-fail-closed`, версия `0.642.0`; admin enable/disable не меняют локальную БД без lifecycle/provider-вызова, а все direct access actions возвращают ранний `503` при недоступном lifecycle.
