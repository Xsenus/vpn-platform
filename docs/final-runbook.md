...
- browser console smoke: 158/158; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-public-catalog-load-recovery`, версия `0.606.0`; public tariffs/payment providers изолируют load failures, сохраняют здоровую область и восстанавливаются явным retry без reload.
- roadmap progress: `619/639` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
