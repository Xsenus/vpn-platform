...
- browser console smoke: 142/142; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-admin-support-messages-retry`, версия `0.598.0`; transient error admin support messages остаётся в карточке диалога, исключает false empty state и имеет explicit retry без logout/reload.
- roadmap progress: `611/631` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
