...
- browser console smoke: 180/180; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-admin-finance-resource-owner`, версия `0.622.0`; payment-provider edit/toggle/check и order/direct payment recheck/refund используют общие identity-safe resource owners и shared busy-state.
- roadmap progress: `635/655` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
