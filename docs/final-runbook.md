...
- latest "Что нового": `2026-08-13-admin-notification-read-boundary`, версия `0.690.0`; notification status/template/search и latest top-500 выполняются в БД до materialization.
- roadmap progress: `703/723` closed, readiness `97.2%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
