...
- latest "Что нового": `2026-08-13-lifecycle-worker-query-boundary`, версия `0.694.0`; order expiry выполняется atomic update, subscription lifecycle читает due-only batches.
