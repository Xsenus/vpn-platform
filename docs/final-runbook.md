...
- browser console smoke: 208/208; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-12-public-payment-link-expiry`, версия `0.633.0`; order-aware current-time expiry timer скрывает public payment redirect без ручного refresh и показывает новый заказ.
