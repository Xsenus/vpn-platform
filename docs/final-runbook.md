...
- browser console smoke: 178/178; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-admin-vpn-infrastructure-resource-owner`, версия `0.621.0`; panel/inbound/client и server/provisioning команды используют иерархические identity-safe resource owners и shared busy-state, включая source/target client migration.
- roadmap progress: `634/654` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
