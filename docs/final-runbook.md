...
- browser console smoke: 214/214; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-12-cabinet-access-grace-expiry`, версия `0.635.0`; backend и открытая вкладка кабинета скрывают VPN-секреты точно по effective access deadline без ожидания lifecycle worker или reload.
- roadmap progress: `648/668` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
