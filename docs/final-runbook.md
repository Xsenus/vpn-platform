...
- latest "Что нового": `2026-08-11-russian-api-error-boundary`, версия `0.588.0`; English JSON/plain errors и native fetch failures не попадают в русскую UI, promo messages сохраняют точный перевод.
