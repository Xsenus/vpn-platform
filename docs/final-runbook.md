...
- latest "Что нового": `2026-08-13-faq-boundary`, версия `0.676.0`; public FAQ скрывает admin metadata, а revision защищает admin PUT/DELETE от параллельных изменений.
