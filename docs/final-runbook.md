...
- latest "Что нового": `2026-08-13-admin-user-overview-read-boundary`, версия `0.685.0`; admin users list и user overview orders/payments/support применяют DB-side limits, а role filter использует точный CSV-токен.
