...
- browser console smoke: 166/166; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-cabinet-data-reload-single-flight`, версия `0.610.0`; manual cabinet `loadAll` возвращает duplicate caller текущий Promise и сбрасывает owner на границе сессии.
- roadmap progress: `623/643` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
