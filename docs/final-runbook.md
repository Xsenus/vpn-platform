...
- browser console smoke: 164/164; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-public-managed-content-load-lifecycle`, версия `0.609.0`; тарифы и аккаунт ограничивают StrictMode managed CMS load одной попыткой на route и отклоняют completion после unmount.
