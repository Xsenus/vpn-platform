...
- browser console smoke: 190/190; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-cabinet-renewal-order-refresh`, версия `0.627.0`; успешный orders reload синхронизирует сохранённый renewal snapshot по ID, а terminal/non-retry карточка не оставляет устаревшую retry-команду.
- roadmap progress: `640/660` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
