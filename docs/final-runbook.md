...
- browser console smoke: 130/130; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-cabinet-app-version-identity-boundary`, версия `0.592.0`; app-version latest/dismissal ждёт profile ID, token/user transition закрывает старое окно, anonymous identity не используется.
- roadmap progress: `605/625` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
