...
- latest "Что нового": `2026-08-14-public-catalog-release-seed-clock`, версия `0.714.0`; public tariff visibility и startup release seed используют единый application clock.
