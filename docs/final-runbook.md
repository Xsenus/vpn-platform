...
- browser console smoke: 188/188; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-cabinet-renewal-provider-availability`, версия `0.626.0`; сохранённый renewal не показывает активный payment retry без доступного provider, control и handler остаются fail-closed.
