...
- latest "Что нового": `2026-08-13-promo-redemption-query-boundary`, версия `0.697.0`; stale promo slots освобождаются атомарно, global/per-user limits считаются в БД.
