...
- backend full suite: 1367/1367;
- frontend tests: 157/157;
- API build: OK;
- frontend typecheck/build: OK;
- fresh local SQLite smoke: OK;
- browser console smoke: 227/227; responsive all-screens: 7/7 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-13-cabinet-referral-boundary`, версия `0.673.0`; кабинет получает минимальный контракт начислений без user/source/program/metadata полей, история ограничивается БД, а cabinet/admin показывают локализованные величины.
- roadmap progress: `686/706` closed, readiness `97.2%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
