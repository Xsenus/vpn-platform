...
- browser console smoke: 94/94; responsive all-screens: 6/6 на 18 viewport-конфигурациях `305x568..2560x1440`;
...
- latest "Что нового": `2026-08-10-admin-vpn-access-actions-lifecycle-e2e`, версия `0.561.0`.
