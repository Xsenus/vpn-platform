...
- latest "Что нового": `2026-08-12-telegram-payment-recovery-provider-lock`, версия `0.656.0`; Telegram recovery не предлагает смену закреплённого провайдера и не раскрывает внутренние ошибки или Stars payload.
