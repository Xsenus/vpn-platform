...
- browser console smoke: 138/138; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-cabinet-payment-provider-retry`, версия `0.596.0`; способы оплаты загружаются одной initial attempt, transient error имеет единый alert и explicit retry без logout/reload.
- roadmap progress: `609/629` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
