...
- browser console smoke: 176/176; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-admin-subscription-access-resource-owner`, версия `0.620.0`; subscription lifecycle и direct VPN access commands используют общие identity-safe resource owners, shared busy-state между разделами и invalidation cached QR.
- roadmap progress: `633/653` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
