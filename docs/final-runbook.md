...
- browser console smoke: 194/194; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-cabinet-terminal-payment-links`, версия `0.628.0`; payment confirmation URL показывается только для `New/Pending/WaitingConfirmation`, terminal/unknown состояние скрывает ссылку во всех cabinet payment surfaces.
- roadmap progress: `641/661` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
