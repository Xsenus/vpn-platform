...
- browser console smoke: 126/126; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-public-managed-error-content`, версия `0.590.0`; initial tariff/provider failures обновляются из delayed managed content, а полный responsive gate завершает неизменную exhaustive matrix под параллельной нагрузкой.
