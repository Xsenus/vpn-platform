...
- browser console smoke: 198/198; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-public-completed-checkout-recovery`, версия `0.630.0`; повторный claim завершённого заказа показывает точный статус и очищает неретрайный persisted checkout до reload.
- roadmap progress: `643/663` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
