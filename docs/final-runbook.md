...
- browser console smoke: 134/134; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-cabinet-app-version-history-retry`, версия `0.594.0`; history failure/empty response не повторяется автоматически, русский alert предлагает explicit retry без layout overflow.
- roadmap progress: `607/627` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
