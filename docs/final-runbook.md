...
- browser console smoke: 170/170; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-admin-user-filter-load-recovery`, версия `0.612.0`; admin user filters возвращают duplicate caller текущий Promise, скрывают stale список при ошибке и поддерживают локальный retry.
