...
- latest "Что нового": `2026-08-13-admin-user-session-revocation-write-boundary`, версия `0.703.0`; деактивация пользователя отзывает active sessions одним set-based write в общей транзакции с user/audit changes.
