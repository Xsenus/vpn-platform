...
- latest "Что нового": `2026-08-13-site-content-boundary`, версия `0.677.0`; public content скрывает admin metadata, а revision защищает admin PUT/DELETE от параллельных изменений.
