...
- latest "Что нового": `2026-08-13-own-vps-latest-read-boundary`, версия `0.700.0`; own-VPS worker выбирает latest subscription/support conversation через DB-side top-1.
