...
- browser console smoke: 150/150; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-admin-initial-data-boundary`, версия `0.602.0`; admin-panel показывает focused loading-state после проверки роли и монтирует operational данные только после первой подтверждённой выборки.
- roadmap progress: `615/635` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
