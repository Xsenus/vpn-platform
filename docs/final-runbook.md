...
- browser console smoke: 206/206; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-12-cabinet-payment-link-expiry`, версия `0.632.0`; order-aware payment policy, current-time render tick и ближайший expiry timer скрывают renewal/retry/history confirmation URL без ручного refresh.
