...
- browser console smoke: 132/132; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-cabinet-app-version-manual-intent`, версия `0.593.0`; ручной app-version intent сохраняется до profile ID внутри текущего token lifecycle и завершается при logout.
- roadmap progress: `606/626` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
