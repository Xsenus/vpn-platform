...
- browser console smoke: 140/140; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-cabinet-support-messages-retry`, версия `0.597.0`; transient error сообщений остаётся в выбранной переписке, исключает false empty state и имеет explicit retry без logout/reload.
- roadmap progress: `610/630` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
