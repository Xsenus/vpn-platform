...
- latest "Что нового": `2026-08-14-app-release-clock-consistency`, версия `0.712.0`; cabinet/admin app-version visibility, mark-seen и mutation timestamps используют единый application clock.
