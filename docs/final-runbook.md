...
- latest "Что нового": `2026-08-14-admin-crud-clock-and-capacity-gates`, версия `0.713.0`; FAQ/content/scenario/Telegram mutations используют единый application clock, capacity concurrency gate принимает оба безопасных пути.
