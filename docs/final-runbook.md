...
- browser console smoke: 128/128; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-cabinet-app-version-session-boundary`, версия `0.591.0`; cabinet latest/history callbacks ограничены текущей token/user generation, а logout/login запускает чистую загрузку без stale history.
