...
- browser console smoke: 186/186; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-cabinet-payment-provider-lock`, версия `0.625.0`; cabinet payment-provider select остаётся disabled/`aria-busy` до завершения renewal или retry-payment и не расходится с отправленным provider snapshot.
