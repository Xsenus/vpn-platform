...
- latest "Что нового": `2026-08-15-vpn-panel-archive-readonly`, версия `0.745.0`; archived panel details сохраняют историю, а inbound/client mutations отклоняются до provider/EF/audit side effects и скрыты в UI.
