...
- browser console smoke: 136/136; responsive all-screens: 6/6 на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints;
...
- latest "Что нового": `2026-08-11-cabinet-app-version-latest-recovery`, версия `0.595.0`; ручная latest-загрузка имеет видимые loading/error/empty состояния, explicit retry и не запускает history до current release.
- roadmap progress: `608/628` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
