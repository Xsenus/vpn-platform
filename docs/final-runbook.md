...
- latest "Что нового": `2026-08-14-redact-before-truncation`, версия `0.724.0`; known secrets и PEM values редактируются до ограничения длины diagnostics, а truncation suffix входит в итоговый лимит.
- roadmap progress: `744/764` closed, readiness `97.4%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
