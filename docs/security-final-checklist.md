...
- Latest local release: `2026-08-10-admin-vpn-access-actions-lifecycle-e2e`, версия `0.561.0`; VPN access revision lifecycle и terminal masking, 3x-ui client actions, safe provisioning warnings и write-only credentials проверены на desktop/mobile, axe WCAG A/AA и best-practice gate без allow-list проверен на desktop и 320 px.
