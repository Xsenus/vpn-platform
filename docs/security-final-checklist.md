...
- Latest local release: `2026-08-10-admin-subscription-actions-lifecycle-e2e`, версия `0.562.0`; subscription/access terminal lifecycle, VPN access revision, 3x-ui client actions, safe provisioning warnings и write-only credentials проверены на desktop/mobile, axe WCAG A/AA и best-practice gate без allow-list проверен на desktop и 320 px.
