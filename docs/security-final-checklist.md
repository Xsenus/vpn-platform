...
- Latest local release: `2026-08-10-admin-provisioning-validation-lifecycle-e2e`, версия `0.559.0`; safe provisioning mode/risk warnings, write-only SSH/panel credentials и secure infrastructure/provider/Telegram lifecycle проверены на desktop/mobile, axe WCAG A/AA и best-practice gate без allow-list проверен на desktop и 320 px.
