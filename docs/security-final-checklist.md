...
- Latest local release: `2026-08-10-admin-vpn-client-actions-lifecycle-e2e`, версия `0.560.0`; 3x-ui client action lifecycle, safe provisioning warnings, write-only SSH/panel credentials и secure infrastructure/provider/Telegram lifecycle проверены на desktop/mobile, axe WCAG A/AA и best-practice gate без allow-list проверен на desktop и 320 px.
