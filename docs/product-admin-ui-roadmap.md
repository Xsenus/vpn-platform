...
- [x] Roadmap progress синхронизирован с master roadmap: `692/712` closed, readiness `97.2%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1424/1424`.
- [x] Frontend unit tests: `169/169`.
...
- [x] Latest "Что нового": `2026-08-13-tariff-boundary`, версия `0.679.0`; public/admin tariff contracts разделены, списки ограничены DB-side top-200, а admin PATCH/DELETE используют optimistic revision с controlled conflict; backend `1424/1424`.
