...
- [x] Roadmap progress синхронизирован с master roadmap: `723/743` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1490/1490`.
...
- [x] Latest "Что нового": `2026-08-13-sqlite-outbox-provisioning-temporal-preflight`, версия `0.709.0`; SQLite migration preflight/local repair сохраняет oldest outbox/provisioning записи при mixed offsets; backend `1490/1490`.
