...
- [x] Roadmap progress синхронизирован с master roadmap: `626/646` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-11-admin-detail-retry-single-flight`, версия `0.613.0`; user overview, support messages и VPN panel details имеют operation/token/entity-scoped Promise owners и не дублируют synchronous retry.
