...
- [x] Roadmap progress синхронизирован с master roadmap: `615/635` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `150/150`.
...
- [x] Latest "Что нового": `2026-08-11-admin-initial-data-boundary`, версия `0.602.0`; verified admin session скрывает operational метрики и очереди до первой фактической загрузки, сохраняя focus и responsive transition.
