...
- [x] Admin VPS smoke report template, generator, validator и явный browser runner готовы для проверки всех разделов админки, но реальный VPS admin smoke еще нужно пройти.
...
- [x] Подготовить безопасный admin VPS smoke report через `docs/admin-vps-smoke-report.template.json`, `scripts/new-admin-vps-smoke-report.ps1` и `scripts/admin-vps-browser-smoke.ps1`.
...
- [x] Encoding guard: OK.
- [x] Secret scan: OK.
- [x] Latest "Что нового": `2026-06-19-admin-vps-browser-smoke`, версия `0.183.0`.
