...
- [x] Roadmap progress синхронизирован с master roadmap: `495/515` closed, readiness `96.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-05-payment-provider-default-uniqueness`, версия `0.483.0`.
