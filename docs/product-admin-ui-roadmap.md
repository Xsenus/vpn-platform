...
- [x] Roadmap progress синхронизирован с master roadmap: `547/567` closed, readiness `96.5%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-09-vpn-panel-api-dto-validation`, версия `0.534.0`.
