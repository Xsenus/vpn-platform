...
- [x] Roadmap progress синхронизирован с master roadmap: `621/641` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `162/162`.
...
- [x] Latest "Что нового": `2026-08-11-public-landing-load-lifecycle`, версия `0.608.0`; главная выполняет по одной initial FAQ/CMS попытке под StrictMode, отклоняет stale completion и восстанавливает FAQ явным retry без ложного empty-state.
