...
- [x] Roadmap progress синхронизирован с master roadmap: `622/642` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `164/164`.
...
- [x] Latest "Что нового": `2026-08-11-public-managed-content-load-lifecycle`, версия `0.609.0`; тарифы и аккаунт выполняют по одной managed CMS попытке на route под StrictMode и отклоняют completion после unmount.
