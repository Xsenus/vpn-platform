...
- [x] Roadmap progress синхронизирован с master roadmap: `498/518` closed, readiness `96.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-05-payment-provider-configuration-check`, версия `0.486.0`.
