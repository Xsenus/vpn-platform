...
- [x] Roadmap progress синхронизирован с master roadmap: `677/697` closed, readiness `97.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1342/1342`.
...
- [x] Latest "Что нового": `2026-08-12-refund-status-reconciliation`, версия `0.664.0`; admin UI сверяет Pending/Unknown refund YooKassa/Stripe/PayPal, показывает provider-specific blockers и применяет сумму идемпотентно; backend `1342/1342`.
