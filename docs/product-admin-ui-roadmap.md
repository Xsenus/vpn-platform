...
- [x] Roadmap progress синхронизирован с master roadmap: `665/685` closed, readiness `97.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1255/1255`.
...
- [x] Latest "Что нового": `2026-08-12-payment-local-sandbox-refund-contract`, версия `0.652.0`; Stripe, PayPal и TBank поддерживают полный credentialless local sandbox refund без HTTP, полный browser inventory `220/220` остаётся зелёным.
