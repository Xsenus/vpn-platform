...
- [x] Roadmap progress синхронизирован с master roadmap: `708/728` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-13-node-allocation-selection-boundary`, версия `0.695.0`; node/panel/sandbox allocation использует DB-side top-1; backend `1470/1470`.
