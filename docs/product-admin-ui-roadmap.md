...
- [x] Roadmap progress синхронизирован с master roadmap: `657/677` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1172/1172`.
...
- [x] Latest "Что нового": `2026-08-12-server-secret-protection-fail-closed`, версия `0.644.0`; backend server create/update возвращает controlled `503` для нового SSH/panel secret без protector, не меняет node/audit и разрешает metadata-only write.
