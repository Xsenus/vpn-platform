...
- [x] Roadmap progress синхронизирован с master roadmap: `633/653` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `176/176`.
...
- [x] Latest "Что нового": `2026-08-11-admin-subscription-access-resource-owner`, версия `0.620.0`; команды одной подписки и связанного VPN-доступа используют общие identity-safe resource owners, не пересекают provider-state mutations между разделами и очищают cached QR.
