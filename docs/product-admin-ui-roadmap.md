...
- [x] Roadmap progress синхронизирован с master roadmap: `720/740` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1485/1485`.
...
- [x] Latest "Что нового": `2026-08-13-provisioning-support-sqlite-latest-boundary`, версия `0.706.0`; provisioning support использует nullable-safe latest SQLite boundary и не создает duplicate conversation; backend `1485/1485`.
