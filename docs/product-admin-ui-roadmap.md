...
- [x] Roadmap progress синхронизирован с master roadmap: `526/546` closed, readiness `96.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-05-provisioning-retry-atomic-queue`, версия `0.513.0`.
