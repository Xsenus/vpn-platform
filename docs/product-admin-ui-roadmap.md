...
- [x] Roadmap progress синхронизирован с master roadmap: `618/638` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `156/156`.
...
- [x] Latest "Что нового": `2026-08-11-public-checkout-session-boundary`, версия `0.605.0`; public checkout result и связанные ID/link очищаются при завершении сессии и не появляются после следующего login.
