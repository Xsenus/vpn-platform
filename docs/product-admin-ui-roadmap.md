...
- [x] Roadmap progress синхронизирован с master roadmap: `711/731` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-13-delivery-dispatch-query-boundary`, версия `0.698.0`; SQLite delivery queues ограничены due/stale batch в БД; backend `1470/1470`.
