...
- [x] Roadmap progress синхронизирован с master roadmap: `617/637` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `154/154`.
...
- [x] Latest "Что нового": `2026-08-11-cabinet-section-load-boundary`, версия `0.604.0`; partial cabinet load failures изолированы по восьми областям, не блокируют подтверждённый профиль и предлагают локальное восстановление без ложных данных.
