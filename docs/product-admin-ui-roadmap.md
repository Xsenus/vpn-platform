...
- [x] Roadmap progress синхронизирован с master roadmap: `739/759` closed, readiness `97.4%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1540/1540`.
...
- [x] Latest "Что нового": `2026-08-14-sqlite-repair-application-clock`, версия `0.719.0`; SQLite migration/repair paths используют единый application-clock snapshot для outbox, provisioning, panel и Telegram timestamps; backend `1540/1540`.
