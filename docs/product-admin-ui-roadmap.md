...
- [x] Admin VPS smoke report template, generator, validator, явный browser runner, preflight, локальная SQLite-проверка runner и strict acceptance evidence gate готовы для проверки всех разделов админки, но реальный VPS admin smoke еще нужно пройти.
...
- [x] Encoding guard: OK.
- [x] Secret scan: OK.
- [x] Latest "Что нового": `2026-06-19-admin-vps-smoke-preflight`, версия `0.186.0`.
