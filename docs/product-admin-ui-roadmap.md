...
- [x] Roadmap progress синхронизирован с master roadmap: `612/632` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-11-admin-detail-recovery`, версия `0.599.0`; user overview и VPN panel details errors локализованы в выбранных карточках, loading/error/detail разделены, retry проверен desktop/mobile.
