...
- [x] Roadmap progress синхронизирован с master roadmap: `590/610` closed, readiness `96.7%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-10-cabinet-url-boundary`, версия `0.577.0`.
