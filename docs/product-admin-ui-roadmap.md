...
- [x] Roadmap progress синхронизирован с master roadmap: `608/628` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `136/136`.
...
- [x] Latest "Что нового": `2026-08-11-cabinet-app-version-latest-recovery`, версия `0.595.0`; manual latest failure/empty остаётся видимым, history ждёт current release, retry проверен desktop/mobile.
