...
- [x] Roadmap progress синхронизирован с master roadmap: `635/655` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Frontend unit tests: `126/126`.
- [x] API Release build: OK.
- [x] Frontend typecheck: OK.
- [x] Frontend production build: OK.
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `180/180`.
...
- [x] Latest "Что нового": `2026-08-11-admin-finance-resource-owner`, версия `0.622.0`; provider account и order/payment finance-команды используют общие identity-safe resource owners и не пересекают provider state mutations между разделами.
