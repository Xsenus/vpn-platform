...
- [x] Roadmap progress синхронизирован с master roadmap: `487/507` closed, readiness `96.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-04-vpn-access-provisioning-consistency`, версия `0.475.0`.
