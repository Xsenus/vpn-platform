...
- [x] Roadmap progress синхронизирован с master roadmap: `684/704` closed, readiness `97.2%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1362/1362`.
- [x] Frontend unit tests: `154/154`.
...
- [x] Latest "Что нового": `2026-08-12-cabinet-order-boundary`, версия `0.671.0`; история и команды заказов кабинета используют минимальные контракты, payment init не раскрывает raw provider response/exception, а Playwright отдельно ожидает public, cabinet и admin SPA; backend `1362/1362`.
