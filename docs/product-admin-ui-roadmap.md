...
- [x] Roadmap progress синхронизирован с master roadmap: `483/503` closed, readiness `96.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-04-outbox-dispatch-recovery`, версия `0.471.0`.
