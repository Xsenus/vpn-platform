...
- [x] Roadmap progress синхронизирован с master roadmap: `703/723` closed, readiness `97.2%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1466/1466`.
...
- [x] Latest "Что нового": `2026-08-13-admin-notification-read-boundary`, версия `0.690.0`; notification filters/latest top-500 ограничены в БД; backend `1466/1466`.
