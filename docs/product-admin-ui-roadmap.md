...
- [x] Roadmap progress синхронизирован с master roadmap: `777/797` closed, readiness `97.5%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1609/1609`.
...
- [x] Latest "Что нового": `2026-08-24-production-email-degraded-mode`, версия `0.753.0`; явный manual deploy без email блокирует password reset контролируемым `503`. Frontend `197/197`, real VPS partial report остаётся `8 passed / 2 failed / 8 blocked`; production admin, SMTP, providers и VPN открыты.
