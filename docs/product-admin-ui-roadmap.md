...
- [x] Roadmap progress синхронизирован с master roadmap: `543/563` closed, readiness `96.4%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-09-cabinet-api-dto-validation`, версия `0.530.0`.
