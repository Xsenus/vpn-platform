...
- [x] Roadmap progress синхронизирован с master roadmap: `512/532` closed, readiness `96.2%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1018/1018`.
- [x] Frontend unit tests: `82/82`.
...
- [x] Latest "Что нового": `2026-08-05-cancelled-subscription-access-boundary`, версия `0.500.0`.
