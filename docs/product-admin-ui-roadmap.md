...
- [x] Roadmap progress синхронизирован с master roadmap: `655/675` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1150/1150`.
...
- [x] Latest "Что нового": `2026-08-12-access-lifecycle-fail-closed`, версия `0.642.0`; admin enable/disable не подтверждают локальный успех без lifecycle/provider-вызова, а все direct access actions используют единый ранний `503` unavailable-контракт.
