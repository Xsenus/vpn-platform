...
- [x] Roadmap progress синхронизирован с master roadmap: `734/754` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1515/1515`.
...
- [x] Latest "Что нового": `2026-08-14-x3ui-safe-client-toggle-runtime-clock`, версия `0.715.0`; 3x-ui toggle сохраняет remote client settings и fail-closed обрабатывает panel responses, JWT/Stripe/provider timestamps используют application clock; backend `1515/1515`.
