...
- [x] Roadmap progress синхронизирован с master roadmap: `722/742` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1486/1486`.
...
- [x] Latest "Что нового": `2026-08-13-sqlite-temporal-repair-preflight`, версия `0.708.0`; SQLite migration preflight/local repair сохраняет правильные Telegram/payment/panel sync записи при mixed offsets; backend `1486/1486`.
