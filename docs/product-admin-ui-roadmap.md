...
- [x] Roadmap progress синхронизирован с master roadmap: `602/622` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-11-runtime-error-ui-boundary`, версия `0.589.0`; public/cabinet/admin не выводят прямой `Error.message`, неизвестные runtime/handler exceptions используют контекстный русский fallback.
