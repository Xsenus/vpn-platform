...
- [x] Roadmap progress синхронизирован с master roadmap: `721/741` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-13-x3ui-sqlite-diagnostics-ordering`, версия `0.707.0`; admin VPN diagnostics используют chronological SQLite ordering для clients/sync/health; backend `1486/1486`.
