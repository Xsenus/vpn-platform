...
- [x] Roadmap progress синхронизирован с master roadmap: `658/678` closed, readiness `97.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1174/1174`.
...
- [x] Latest "Что нового": `2026-08-12-validation-deploy-executor-guard`, версия `0.645.0`; backend executor удерживает validation node в deterministic mock независимо от live-флагов и fail closed для отключённого live execution.
