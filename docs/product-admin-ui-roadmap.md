...
- [x] Roadmap progress синхронизирован с master roadmap: `673/693` closed, readiness `97.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-12-paypal-capture-id-refund`, версия `0.660.0`; PayPal refund отправляется по вложенному capture ID, payment/refund regression `75/75`, browser suite остаётся `227/227`.
