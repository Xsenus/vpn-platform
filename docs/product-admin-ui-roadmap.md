...
- [x] Roadmap progress синхронизирован с master roadmap: `601/621` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-11-russian-api-error-boundary`, версия `0.588.0`; English backend phrases и native `Failed to fetch` не попадают в UI, promo failures сохраняют точные русские подсказки.
