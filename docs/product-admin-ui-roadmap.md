...
- [x] Roadmap progress синхронизирован с master roadmap: `645/665` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Frontend unit tests: `132/132`.
- [x] API Release build: OK.
- [x] Frontend typecheck: OK.
- [x] Frontend production build: OK.
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `206/206`.
...
- [x] Latest "Что нового": `2026-08-12-cabinet-payment-link-expiry`, версия `0.632.0`; cabinet связывает confirmation URL с родительским заказом и автоматически скрывает её при expiry без ручного refresh или stale login-time clock.
