...
- [x] Roadmap progress синхронизирован с master roadmap: `705/725` closed, readiness `97.2%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1467/1467`.
...
- [x] Latest "Что нового": `2026-08-13-subscription-migration-selection-boundary`, версия `0.692.0`; auto-target migration выбирает node/panel/inbound одним query; backend `1467/1467`.
