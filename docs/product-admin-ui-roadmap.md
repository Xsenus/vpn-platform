...
- [x] Roadmap progress синхронизирован с master roadmap: `771/791` closed, readiness `97.5%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1595/1595`.
...
- [x] Latest "Что нового": `2026-08-15-server-archive-provisioning-readonly`, версия `0.748.0`; backend `1595/1595`, frontend `196/196`, полный Playwright `282/282`, archived provisioning/SQLite `4/4` зелёные.
