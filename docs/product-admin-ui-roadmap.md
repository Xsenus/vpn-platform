...
- [x] Roadmap progress синхронизирован с master roadmap: `604/624` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `128/128`.
...
- [x] Latest "Что нового": `2026-08-11-cabinet-app-version-session-boundary`, версия `0.591.0`; cabinet app-version state сбрасывается при token/user change, а session/latest/history generations отклоняют stale callbacks после logout/login.
