...
- [x] Roadmap progress синхронизирован с master roadmap: `479/499` closed, readiness `96.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-04-telegram-update-recovery`, версия `0.467.0`.
