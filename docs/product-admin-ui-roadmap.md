...
- [x] Roadmap progress синхронизирован с master roadmap: `644/664` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `200/200`.
...
- [x] Latest "Что нового": `2026-08-11-public-checkout-session-expiry`, версия `0.631.0`; public checkout сохраняет session expiry и блокирует истёкший pre-claim/legacy flow без payment init.
