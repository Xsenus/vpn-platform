...
- [x] Admin VPS smoke report template, generator, validator, явный browser runner и локальная SQLite-проверка runner готовы для проверки всех разделов админки, но реальный VPS admin smoke еще нужно пройти.
...
- [x] Encoding guard: OK.
- [x] Secret scan: OK.
- [x] Latest "Что нового": `2026-06-19-local-admin-vps-browser-smoke`, версия `0.184.0`.
