...
- [x] Roadmap progress синхронизирован с master roadmap: `760/780` closed, readiness `97.4%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1569/1569`.
- [x] Frontend unit tests: `185/185`.
...
- [x] Admin production bundle budget: `5` chunks, largest `270715`, total raw `579420/580608`, gzip `154073/154624`.
...
- [x] Latest "Что нового": `2026-08-15-commercial-editor-noop-integrity`, версия `0.737.0`; backend `1569/1569`, frontend `185/185`, полный Playwright `276/276`, fresh SQLite `managedNoOp=400`, `commerceNoOps=400,400,400` зелёные.
