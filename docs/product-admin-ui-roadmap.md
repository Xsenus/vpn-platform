...
- [x] Roadmap progress синхронизирован с master roadmap: `634/654` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `178/178`.
...
- [x] Latest "Что нового": `2026-08-11-admin-vpn-infrastructure-resource-owner`, версия `0.621.0`; panel/inbound/client и server/provisioning команды используют иерархические identity-safe resource owners и не пересекают remote state mutations между разделами.
