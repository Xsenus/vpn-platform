...
- [x] Roadmap progress синхронизирован с master roadmap: `605/625` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `130/130`.
...
- [x] Latest "Что нового": `2026-08-11-cabinet-app-version-identity-boundary`, версия `0.592.0`; cabinet app-version ждёт profile ID, token/user transition закрывает старое окно, user-specific dismissal не смешивается с hydration.
