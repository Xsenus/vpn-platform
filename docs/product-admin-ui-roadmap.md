...
- [x] Roadmap progress синхронизирован с master roadmap: `728/748` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1495/1495`.
...
- [x] Latest "Что нового": `2026-08-14-app-release-clock-consistency`, версия `0.712.0`; cabinet/admin app-version workflow использует единый application clock; backend `1495/1495`.
