...
- [x] Roadmap progress синхронизирован с master roadmap: `607/627` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `134/134`.
...
- [x] Latest "Что нового": `2026-08-11-cabinet-app-version-history-retry`, версия `0.594.0`; history failure/empty response завершает одну attempt, русский alert и retry проверены desktop/mobile.
