...
- [x] Roadmap progress синхронизирован с master roadmap: `497/517` closed, readiness `96.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-05-payment-recheck-cancellation`, версия `0.485.0`.
