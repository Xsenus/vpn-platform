...
- [x] Roadmap progress синхронизирован с master roadmap: `730/750` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1499/1499`.
...
- [x] Latest "Что нового": `2026-08-14-admin-crud-clock-and-capacity-gates`, версия `0.713.0`; admin CRUD/Telegram используют application clock, capacity gate учитывает safe early rejection; backend `1499/1499`.
