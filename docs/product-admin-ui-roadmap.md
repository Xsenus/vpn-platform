...
- [x] Roadmap progress синхронизирован с master roadmap: `656/676` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1166/1166`.
...
- [x] Latest "Что нового": `2026-08-12-server-payload-validation`, версия `0.643.0`; backend server create/update повторяет semantic validation, проверяет node group до записи и сохраняет только нормализованный валидный payload.
