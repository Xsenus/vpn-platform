...
- [x] Roadmap progress синхронизирован с master roadmap: `768/788` closed, readiness `97.5%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1589/1589`.
...
- [x] Latest "Что нового": `2026-08-15-vpn-panel-archive-readonly`, версия `0.745.0`; backend `1589/1589`, frontend `196/196`, полный Playwright `282/282`, archived child mutation/SQLite `2/2` зелёные.
