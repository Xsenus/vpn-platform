...
- [x] Roadmap progress синхронизирован с master roadmap: `641/661` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Frontend unit tests: `129/129`.
- [x] API Release build: OK.
- [x] Frontend typecheck: OK.
- [x] Frontend production build: OK.
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `194/194`.
...
- [x] Latest "Что нового": `2026-08-11-cabinet-terminal-payment-links`, версия `0.628.0`; terminal/unknown платежи не показывают устаревшие provider confirmation URL в cabinet payment surfaces.
