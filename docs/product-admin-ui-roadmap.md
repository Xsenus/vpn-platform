...
- [x] Roadmap progress синхронизирован с master roadmap: `643/663` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `198/198`.
...
- [x] Latest "Что нового": `2026-08-11-public-completed-checkout-recovery`, версия `0.630.0`; public checkout показывает точный результат повторного claim и очищает неретрайное persisted состояние до reload.
