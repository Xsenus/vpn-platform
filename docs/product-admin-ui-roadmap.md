...
- [x] Roadmap progress синхронизирован с master roadmap: `624/644` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `168/168`.
...
- [x] Latest "Что нового": `2026-08-11-admin-data-reload-single-flight`, версия `0.611.0`; ручная aggregate-перезагрузка админки имеет operation/token/session-scoped Promise owner и не дублирует полный набор admin GET.
