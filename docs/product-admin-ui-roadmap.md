...
- [x] Roadmap progress синхронизирован с master roadmap: `611/631` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `142/142`.
...
- [x] Latest "Что нового": `2026-08-11-admin-support-messages-retry`, версия `0.598.0`; admin support messages error локализован в карточке диалога, error/empty разделены, retry проверен desktop/mobile.
