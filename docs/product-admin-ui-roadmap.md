...
- [x] Roadmap progress синхронизирован с master roadmap: `710/730` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-13-promo-redemption-query-boundary`, версия `0.697.0`; stale promo slots и global/per-user counts обрабатываются в БД; backend `1470/1470`.
