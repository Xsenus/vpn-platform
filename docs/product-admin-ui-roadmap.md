...
- [x] Roadmap progress синхронизирован с master roadmap: `459/479` closed, readiness `95.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Encoding guard: OK.
- [x] Secret scan: OK.
- [x] Latest "Что нового": `2026-07-02-agent-image-attachment-guard`, версия `0.447.0`.
