...
- [x] Roadmap progress синхронизирован с master roadmap: `664/684` closed, readiness `97.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1240/1240`.
...
- [x] Latest "Что нового": `2026-08-12-payment-refund-capability-preflight`, версия `0.651.0`; refund capability повторно проверяется внутри orchestrator до reservation/provider call, полный browser inventory `220/220` остаётся зелёным.
