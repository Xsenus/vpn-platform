...
- [x] Roadmap progress синхронизирован с master roadmap: `527/547` closed, readiness `96.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1061/1061`.
...
- [x] Latest "Что нового": `2026-08-05-provisioning-cancel-claim-boundary`, версия `0.514.0`.
