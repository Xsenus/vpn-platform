...
- [x] Roadmap progress синхронизирован с master roadmap: `709/729` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1470/1470`.
...
- [x] Latest "Что нового": `2026-08-13-referral-reward-read-boundary`, версия `0.696.0`; referral relationship/program window применяются до materialization; backend `1470/1470`.
