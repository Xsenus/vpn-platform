...
- [x] Roadmap progress синхронизирован с master roadmap: `740/760` closed, readiness `97.4%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1541/1541`.
...
- [x] Latest "Что нового": `2026-08-14-enum-input-boundaries`, версия `0.720.0`; admin notification/order filters и Telegram payment callback отклоняют unknown/numeric undefined enum-значения; backend `1541/1541`.
