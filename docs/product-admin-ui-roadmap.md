...
- [x] Roadmap progress синхронизирован с master roadmap: `680/700` closed, readiness `97.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1355/1355`.
- [x] Frontend unit tests: `149/149`.
...
- [x] Latest "Что нового": `2026-08-12-admin-webhook-event-boundary`, версия `0.667.0`; admin UI показывает безопасные terminal/retryable/attention webhook states без provider diagnostics, включая responsive layout; backend `1355/1355`.
