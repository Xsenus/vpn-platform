...
- [x] Roadmap progress синхронизирован с master roadmap: `610/630` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `140/140`.
...
- [x] Latest "Что нового": `2026-08-11-cabinet-support-messages-retry`, версия `0.597.0`; support messages error локализован в переписке, error/empty разделены, retry проверен desktop/mobile.
