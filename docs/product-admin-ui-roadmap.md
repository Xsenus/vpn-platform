...
- [x] Roadmap progress синхронизирован с master roadmap: `745/765` closed, readiness `97.4%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1553/1553`.
...
- [x] Latest "Что нового": `2026-08-14-structured-json-secret-isolation`, версия `0.725.0`; nested JSON secrets и системные Telegram settings изолированы; backend `1553/1553`.
