...
- [x] Roadmap progress синхронизирован с master roadmap: `700/720` closed, readiness `97.2%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1463/1463`.
...
- [x] Latest "Что нового": `2026-08-13-admin-finance-read-boundary`, версия `0.687.0`; payments/refunds/order recheck используют DB-side top-300/top-1 с прежним readiness/RBAC; backend `1463/1463`.
