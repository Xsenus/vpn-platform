...
- [x] Roadmap progress синхронизирован с master roadmap: `642/662` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Frontend unit tests: `130/130`.
- [x] API Release build: OK.
- [x] Frontend typecheck: OK.
- [x] Frontend production build: OK.
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `196/196`.
...
- [x] Latest "Что нового": `2026-08-11-public-expired-partial-checkout`, версия `0.629.0`; публичный partial checkout проверяет persisted status/`expiresAt` до payment init и предлагает новый заказ вместо retry просроченной оплаты.
