...
- [x] Roadmap progress синхронизирован с master roadmap: `494/514` closed, readiness `96.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-05-vpn-node-state-consistency`, версия `0.482.0`.
