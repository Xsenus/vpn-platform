...
- [x] Roadmap progress синхронизирован с master roadmap: `653/673` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1146/1146`.
...
- [x] Latest "Что нового": `2026-08-12-access-sync-read-failure`, версия `0.640.0`; read-only sync failure сохраняет Active/Disabled, timestamp и revision, записывая только redacted `provider_read_failed` audit.
