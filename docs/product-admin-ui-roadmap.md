...
- [x] Roadmap progress синхронизирован с master roadmap: `704/724` closed, readiness `97.2%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-13-admin-dashboard-aggregate-boundary`, версия `0.691.0`; dashboard metrics считаются DB-side aggregates; backend `1467/1467`.
