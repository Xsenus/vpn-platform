...
- [x] Roadmap progress синхронизирован с master roadmap: `676/696` closed, readiness `97.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1328/1328`.
...
- [x] Latest "Что нового": `2026-08-12-refund-proof-boundary`, версия `0.663.0`; refund YooKassa/Stripe/PayPal/Т-Банк проверяет provider proof до локальной mutation, production adapters + SQLite `14/14`, backend `1328/1328`.
