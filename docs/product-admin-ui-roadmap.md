...
- [x] Roadmap progress синхронизирован с master roadmap: `606/626` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `132/132`.
...
- [x] Latest "Что нового": `2026-08-11-cabinet-app-version-manual-intent`, версия `0.593.0`; manual app-version signal ждёт profile ID при активном token и не переносится через logout.
