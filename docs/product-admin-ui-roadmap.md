...
- [x] Roadmap progress синхронизирован с master roadmap: `471/491` closed, readiness `95.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-04-admin-operation-audit-integrity`, версия `0.459.0`.
