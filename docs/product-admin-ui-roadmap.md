...
- [x] Roadmap progress синхронизирован с master roadmap: `540/560` closed, readiness `96.4%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-05-api-response-size-boundary`, версия `0.527.0`.
