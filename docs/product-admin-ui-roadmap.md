...
- [x] Roadmap progress синхронизирован с master roadmap: `732/752` closed, readiness `97.3%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1501/1501`.
...
- [x] Latest "Что нового": `2026-08-14-public-catalog-release-seed-clock`, версия `0.714.0`; public catalog/release seed используют application clock; backend `1501/1501`.
