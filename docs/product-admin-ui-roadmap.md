...
- [x] Roadmap progress синхронизирован с master roadmap: `609/629` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `138/138`.
...
- [x] Latest "Что нового": `2026-08-11-cabinet-payment-provider-retry`, версия `0.596.0`; provider discovery дедуплицирован под StrictMode, error/empty разделены, retry проверен desktop/mobile.
