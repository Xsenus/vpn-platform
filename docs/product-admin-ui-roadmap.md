...
- [x] Roadmap progress синхронизирован с master roadmap: `654/674` closed, readiness `97.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1147/1147`.
...
- [x] Latest "Что нового": `2026-08-12-access-revision-sequence`, версия `0.641.0`; successful sync/reset, provider uncertainty/error, fallback API и expiry worker повышают access revision, а read-only failure сохраняет версию.
