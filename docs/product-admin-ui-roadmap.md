...
- [x] Roadmap progress синхронизирован с master roadmap: `537/557` closed, readiness `96.4%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-05-admin-readiness-link-boundary`, версия `0.524.0`.
