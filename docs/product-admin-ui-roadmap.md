...
- [x] Roadmap progress синхронизирован с master roadmap: `627/647` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-11-admin-auth-command-single-flight`, версия `0.614.0`; login, manual refresh и logout админки имеют operation-scoped Promise owners и не дублируют synchronous activation.
