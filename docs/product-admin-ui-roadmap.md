...
- [x] Roadmap progress синхронизирован с master roadmap: `616/636` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `152/152`.
...
- [x] Latest "Что нового": `2026-08-11-admin-section-load-boundary`, версия `0.603.0`; partial admin load failures скрывают fallback-данные затронутого раздела, сохраняют здоровые разделы и предлагают локальное восстановление.
