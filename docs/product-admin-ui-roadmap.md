...
- [x] Roadmap progress синхронизирован с master roadmap: `530/550` closed, readiness `96.4%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1087/1087`.
- [x] Frontend unit tests: `89/89`.
...
- [x] Latest "Что нового": `2026-08-05-referral-reward-lifecycle`, версия `0.517.0`.
