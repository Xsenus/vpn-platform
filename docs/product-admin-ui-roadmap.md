...
- [x] Roadmap progress синхронизирован с master roadmap: `544/564` closed, readiness `96.5%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-09-admin-core-api-dto-validation`, версия `0.531.0`.
