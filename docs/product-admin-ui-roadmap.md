...
- [x] Roadmap progress синхронизирован с master roadmap: `623/643` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `166/166`.
...
- [x] Latest "Что нового": `2026-08-11-cabinet-data-reload-single-flight`, версия `0.610.0`; ручная aggregate-перезагрузка кабинета имеет session/token-scoped Promise owner и не дублирует восемь приватных GET.
