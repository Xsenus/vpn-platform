...
- [x] Roadmap progress синхронизирован с master roadmap: `533/553` closed, readiness `96.4%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-05-checkout-operation-guard`, версия `0.520.0`.
