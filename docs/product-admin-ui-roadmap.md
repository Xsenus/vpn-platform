...
- [x] Roadmap progress синхронизирован с master roadmap: `482/502` closed, readiness `96.0%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Latest "Что нового": `2026-08-04-telegram-notification-enqueue-deduplication`, версия `0.470.0`.
