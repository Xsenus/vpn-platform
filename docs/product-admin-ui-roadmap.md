...
- [x] Roadmap progress синхронизирован с master roadmap: `672/692` closed, readiness `97.1%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Backend full suite: `1300/1300`.
...
- [x] Latest "Что нового": `2026-08-12-provider-refund-payload-recovery`, версия `0.659.0`; Stripe/PayPal refund восстанавливает provider-specific ID после malformed stored payload, payment/refund regression `75/75`, browser suite остаётся `227/227`.
