...
- [x] Roadmap progress синхронизирован с master roadmap: `625/645` closed, readiness `96.9%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `170/170`.
...
- [x] Latest "Что нового": `2026-08-11-admin-user-filter-load-recovery`, версия `0.612.0`; фильтры пользователей имеют operation/token/search/status-scoped Promise owner, локальную recovery-панель без stale списка и явный retry.
