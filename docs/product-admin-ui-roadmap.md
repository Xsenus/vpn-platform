...
- [x] Roadmap progress синхронизирован с master roadmap: `603/623` closed, readiness `96.8%`, `20` remaining, `19` open, `1` in progress, `0` blocked.
...
- [x] Playwright public/cabinet/admin/all-screens/mobile/console smoke: `126/126`.
...
- [x] Latest "Что нового": `2026-08-11-public-managed-error-content`, версия `0.590.0`; public tariffs применяет delayed managed load-error content, initial requests защищены от late unmount completion, exhaustive responsive coverage проходит под полной нагрузкой.
