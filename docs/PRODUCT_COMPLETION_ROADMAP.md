...
- [x] `STATE-014` Roadmap и текущие статусные документы синхронизированы с проверками 2026-06-14.
  - Что сделано: верхний статус roadmap, README, final runbook, release decision, changelog, TEST_RESULTS, product/admin UI roadmap и seed "Что нового" приведены к одному состоянию: backend `843/843`, frontend `66/66`, browser console smoke `12/12`, responsive all-screens `6/6`, dependency audit `0 vulnerabilities`, latest release `2026-08-04-subscription-activation-compensation`, версия `0.466.0`.
