...
- Latest "Что нового": `2026-07-01-production-handoff-package-archive-rooted-entry-cleanup`, версия `0.350.0`; production evidence handoff package archive rooted-entry regression now cleans its temporary artifacts. Production readiness gate и full live VPS/staging evidence все еще требуются.
