...
- Latest "Что нового": `2026-07-02-readme-external-evidence-open-guard`, версия `0.421.0`; README now guards current release status and production limitations. Production readiness gate и full live VPS/staging evidence все еще требуются.
