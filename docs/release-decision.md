...
- Latest "Что нового": `2026-07-02-roadmap-progress-remaining-guard`, версия `0.413.0`; roadmap current-state tests now verify that header remaining count matches actual checklist markers. Production readiness gate и full live VPS/staging evidence все еще требуются.
