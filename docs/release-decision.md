...
- Latest "Что нового": `2026-06-23-admin-vps-readiness-provider-mode`, версия `0.273.0`; admin VPS bootstrap readiness validator now rejects localSqlite reports whose provider is not `Sqlite`. Production readiness gate и live VPS/staging evidence все еще требуются.
