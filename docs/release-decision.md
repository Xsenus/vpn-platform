...
- Latest "Что нового": `2026-08-12-refund-create-recovery`, версия `0.666.0`; неопределённый refund create сохраняется как безопасный durable `202`, а точный idempotent retry доступен только для YooKassa/Stripe/PayPal с теми же amount/reason. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
