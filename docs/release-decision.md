...
- Latest "Что нового": `2026-07-01-production-handoff-package-archive-ci-regression-default-cleanup`, версия `0.354.0`; production evidence handoff package archive CI regression now removes its autogenerated default output after simple local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
