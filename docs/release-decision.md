...
- Latest "Что нового": `2026-06-23-admin-vps-email-guard`, версия `0.266.0`; admin VPS smoke/bootstrap wrappers now fail-fast validate AdminEmail before preflight, readiness, bootstrap reset and smoke artifacts. Production readiness gate и live VPS/staging evidence все еще требуются.
