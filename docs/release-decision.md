...
- Latest "Что нового": `2026-07-02-production-handoff-receipt-release-guard-cleanup`, версия `0.369.0`; production evidence handoff receipt release guard now removes its autogenerated default tmp output after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
