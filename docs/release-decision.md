...
- Latest "Что нового": `2026-08-04-x3ui-failure-compensation-hardening`, версия `0.460.0`; локальный backend/frontend/SQLite/browser regression и responsive matrix пройдены. Production readiness gate и full live VPS/staging evidence все еще требуются.
