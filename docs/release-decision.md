...
- Latest "Что нового": `2026-08-14-cabinet-support-clock-consistency`, версия `0.711.0`; cabinet support create/reply/status сохраняют согласованные timestamps через application clock. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
