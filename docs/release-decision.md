...
- Latest "Что нового": `2026-08-12-payment-refund-capability-preflight`, версия `0.651.0`; unsupported refund блокируется общим service contract до durable reservation и provider call. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
