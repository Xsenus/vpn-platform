...
- Latest "Что нового": `2026-08-05-cabinet-expired-order-payment-guard`, версия `0.489.0`; локальный backend/frontend/SQLite/browser regression и responsive matrix пройдены. Production readiness gate и full live VPS/staging evidence все еще требуются.
