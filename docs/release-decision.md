...
- Latest "Что нового": `2026-07-01-production-handoff-receipt-release-guard`, версия `0.328.0`; production evidence handoff receipt generation now rejects unknown archive release ids before writing receipt artifacts. Production readiness gate и full live VPS/staging evidence все еще требуются.
