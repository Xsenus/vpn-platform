...
- Latest "Что нового": `2026-08-09-admin-core-api-dto-validation`, версия `0.531.0`; локальный backend/frontend/SQLite/browser regression и responsive matrix пройдены. Real SMTP и полный live VPS/staging evidence все еще требуются.
- Roadmap progress: `544/564` closed, readiness `96.5%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
