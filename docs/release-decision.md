...
- Latest "Что нового": `2026-08-13-app-release-boundary`, версия `0.675.0`; cabinet app releases используют минимальный contract, списки ограничены DB-side top-50/top-200, а optimistic revision защищает admin PUT/DELETE. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
