...
- Latest "Что нового": `2026-07-02-production-handoff-receipt-markdown-verified-files-guard-cleanup`, версия `0.373.0`; production evidence handoff receipt Markdown verified files guard now removes its autogenerated default tmp output after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
