...
- Latest "Что нового": `2026-08-13-work-scenario-boundary`, версия `0.678.0`; admin work scenarios используют DB-side bound, точный contract, согласованные field limits и optimistic revision для PUT/DELETE. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
