...
- Latest "Что нового": `2026-07-02-admin-vps-smoke-preflight-validator-cleanup`, версия `0.388.0`; admin VPS smoke preflight validator regression now removes default local artifacts after ordinary runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
