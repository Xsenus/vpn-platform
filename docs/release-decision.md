...
- Latest "Что нового": `2026-08-11-admin-detail-recovery`, версия `0.599.0`; user overview и VPN panel detail failures остаются в выбранных карточках, false selection/empty states скрыты, generation-guarded retry не сбрасывает selection/session. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
