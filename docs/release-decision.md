...
- Latest "Что нового": `2026-07-01-production-handoff-package-archive-flow-default-cleanup`, версия `0.353.0`; production evidence handoff package archive flow now removes its autogenerated default output after simple local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
