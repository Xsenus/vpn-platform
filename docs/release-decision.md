...
- Browser console smoke: `88/88`; responsive all-screens: `6/6` на 18 viewport-конфигурациях `305x568..2560x1440`; local WebP decode и representative screenshots проверены.
...
- Latest "Что нового": `2026-08-10-admin-vpn-infrastructure-secure-lifecycle-e2e`, версия `0.558.0`; локальный backend/frontend/browser regression и secure admin infrastructure/provider/bot lifecycle на desktop/mobile пройдены. Real provider/Telegram/SMTP delivery и полный live VPS/staging/production-like 3x-ui evidence все еще требуются.
