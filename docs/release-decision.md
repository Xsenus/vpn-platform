...
- Latest "Что нового": `2026-07-01-production-handoff-package-archive-whitespace-entry-guard`, версия `0.341.0`; production evidence handoff package archive validation now has regression coverage for whitespace ZIP entries. Production readiness gate и full live VPS/staging evidence все еще требуются.
