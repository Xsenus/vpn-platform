...
- Latest "Что нового": `2026-08-12-admin-payment-recheck-boundary`, версия `0.665.0`; admin payment/order recheck не раскрывает provider payload/diagnostics, выполняет readiness preflight и сохраняет actor-aware audit до внешнего вызова. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
