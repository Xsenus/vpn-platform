...
- Latest "Что нового": `2026-07-01-production-handoff-package-archive-backslash-entry-guard`, версия `0.337.0`; production evidence handoff package archive validation now has regression coverage for Windows-style backslash ZIP entries. Production readiness gate и full live VPS/staging evidence все еще требуются.
