...
- Browser console smoke: `160/160`; responsive all-screens: `6/6` на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints; local WebP decode и representative screenshots проверены.
...
- Latest "Что нового": `2026-08-11-public-faq-load-lifecycle`, версия `0.607.0`; public FAQ имеет single-flight StrictMode load, stale callback guards и локальное recovery без false empty. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
