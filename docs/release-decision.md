...
- Latest "Что нового": `2026-08-09-admin-finance-support-api-dto-validation`, версия `0.532.0`; локальный backend/frontend/SQLite/browser regression и responsive matrix пройдены. Real SMTP и полный live VPS/staging evidence все еще требуются.
- Roadmap progress: `545/565` closed, readiness `96.5%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
