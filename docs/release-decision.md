...
- Latest "Что нового": `2026-07-02-vps-production-smoke-latest-release-guard-cleanup`, версия `0.378.0`; VPS production smoke latest release guard now removes its autogenerated stale release report and empty tmp directory after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
