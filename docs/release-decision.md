...
- Latest "Что нового": `2026-07-01-production-handoff-checklist-latest-release-guard-cleanup`, версия `0.359.0`; production evidence handoff checklist latest-release guard now removes its autogenerated default tmp output after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
