...
- Latest "Что нового": `2026-07-02-admin-vps-smoke-report-validator-cleanup`, версия `0.387.0`; admin VPS smoke report validator regression now tracks latest active release and removes default local artifacts after ordinary runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
