...
- Latest "Что нового": `2026-07-01-vps-production-smoke-latest-release-guard`, версия `0.302.0`; VPS production smoke acceptance now rejects stale release evidence before `P11-ACC-002` can be accepted. Production readiness gate и full live VPS/staging evidence все еще требуются.
