...
- Latest "Что нового": `2026-07-02-payment-smoke-release-guard-cleanup`, версия `0.381.0`; Payment provider smoke release guard harnesses now remove their autogenerated reports and empty tmp directory after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
