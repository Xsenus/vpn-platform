...
- Latest "Что нового": `2026-07-01-production-handoff-package-archive-directory-entry-cleanup`, версия `0.346.0`; production evidence handoff package archive directory-entry regression now cleans its temporary artifacts. Production readiness gate и full live VPS/staging evidence все еще требуются.
