...
- Latest "Что нового": `2026-07-01-production-handoff-package-archive-duplicate-entry-guard`, версия `0.334.0`; production evidence handoff package archive validation now has regression coverage for duplicated ZIP entries. Production readiness gate и full live VPS/staging evidence все еще требуются.
