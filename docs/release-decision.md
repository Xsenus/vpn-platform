...
- Latest "Что нового": `2026-08-13-admin-notification-read-boundary`, версия `0.690.0`; notification status/template/search/latest top-500 ограничены в БД до materialization. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
