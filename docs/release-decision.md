...
- Latest "Что нового": `2026-08-15-vpn-panel-archive-readonly`, версия `0.745.0`; семь child mutation guards, SQLite no-mutation и read-only details UI проверены backend/desktop/mobile regressions. Real production-like 3x-ui/x-ui, VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging evidence всё ещё требуются.
