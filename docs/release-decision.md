...
- Browser console smoke: `114/114`; responsive all-screens: `6/6` на 18 viewport-конфигурациях `305x568..2560x1440`; local WebP decode и representative screenshots проверены.
...
- Admin production bundle: `5` chunks, largest `219849`, total raw `512438`, gzip `137533`; fail-closed budget пройден.
...
- Latest "Что нового": `2026-08-10-admin-invalid-hash-canonical-fallback`, версия `0.571.0`; локальный backend/frontend/browser regression, admin/public metadata, `404`, bundle budget, SupportAgent, payment refund и VPN lifecycle пройдены. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
