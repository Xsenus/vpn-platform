...
- Latest "Что нового": `2026-07-02-production-handoff-ci-summary-latest-release-guard-cleanup`, версия `0.362.0`; production evidence handoff package archive CI summary latest-release guard now removes its autogenerated default tmp output after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
