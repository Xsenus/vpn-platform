...
- Latest "Что нового": `2026-08-05-x3ui-panel-health-consistency`, версия `0.481.0`; локальный backend/frontend/SQLite/browser regression и responsive matrix пройдены. Production readiness gate и full live VPS/staging evidence все еще требуются.
