...
- Browser console smoke: `40/40`; responsive all-screens: `6/6`.
...
- Latest "Что нового": `2026-08-09-cabinet-restored-session-refresh`, версия `0.545.0`; локальный backend/frontend/SQLite/browser regression и responsive matrix пройдены. Real SMTP и полный live VPS/staging evidence все еще требуются.
