...
- Latest "Что нового": `2026-07-02-production-handoff-checklist-markdown-gates-guard-cleanup`, версия `0.374.0`; production evidence handoff checklist Markdown gates guard now removes its autogenerated default tmp output after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
