...
- Latest "Что нового": `2026-08-14-automatic-entity-application-clock`, версия `0.722.0`; audit и operational timestamps новых сущностей назначаются через application clock, без доменного process-time fallback. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
