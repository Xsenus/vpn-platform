...
- Latest "Что нового": `2026-07-01-production-handoff-package-archive-entry-case-guard`, версия `0.342.0`; production evidence handoff package archive validation now requires exact ZIP entry name casing. Production readiness gate и full live VPS/staging evidence все еще требуются.
