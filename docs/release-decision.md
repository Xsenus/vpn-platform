...
- Latest "Что нового": `2026-08-12-admin-webhook-event-boundary`, версия `0.667.0`; admin webhook read-model ограничен последними 200 событиями, не раскрывает internal diagnostics и показывает безопасное recovery-состояние. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
