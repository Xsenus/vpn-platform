...
- Latest "Что нового": `2026-06-23-admin-vps-environment-default`, версия `0.269.0`; admin VPS smoke/bootstrap wrappers now resolve deterministic environment names before preflight, readiness, bootstrap reset and smoke artifacts. Production readiness gate и live VPS/staging evidence все еще требуются.
