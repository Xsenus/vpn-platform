...
- Latest "Что нового": `2026-07-01-production-handoff-flow-result-latest-release-guard-cleanup`, версия `0.360.0`; production evidence handoff package archive flow result latest-release guard now removes its autogenerated default tmp output after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
