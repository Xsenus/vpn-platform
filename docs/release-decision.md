...
- Latest "Что нового": `2026-07-02-production-readiness-summary-self-link`, версия `0.409.0`; Production readiness summary now self-links `summaryPath` and `jsonSummaryPath`, and the validator rejects mismatched summary paths. Production readiness gate и full live VPS/staging evidence все еще требуются.
