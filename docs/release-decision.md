...
- Latest "Что нового": `2026-08-13-admin-referral-program-boundary`, версия `0.674.0`; admin referral programs используют DB-side top-200, optimistic revision и lossless structured editing. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
