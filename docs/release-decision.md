...
- Latest "Что нового": `2026-07-02-release-seed-identity-guard`, версия `0.427.0`; RoadmapCurrentStateTests now guard release seed identity fields against duplicates. Production readiness gate и full live VPS/staging evidence все еще требуются.
