...
- Latest "Что нового": `2026-07-02-vpn-live-smoke-latest-release-guard-cleanup`, версия `0.380.0`; VPN live smoke latest release guard now removes its autogenerated stale release report and empty tmp directory after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
