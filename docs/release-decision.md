...
- Latest "Что нового": `2026-08-13-refresh-family-query-boundary`, версия `0.701.0`; современные refresh families отзываются одним family query с сохранением legacy fallback. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
