...
- Latest "Что нового": `2026-08-14-sqlite-repair-application-clock`, версия `0.719.0`; SQLite migration/repair paths используют единый application-clock snapshot для outbox, provisioning, panel и Telegram timestamps. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
