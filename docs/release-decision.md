...
- Latest "Что нового": `2026-07-02-product-roadmap-external-evidence-open-guard`, версия `0.422.0`; product/admin UI roadmap now guards current validation status and production limitations. Production readiness gate и full live VPS/staging evidence все еще требуются.
