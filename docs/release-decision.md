...
- Latest "Что нового": `2026-07-01-production-handoff-receipt-markdown-verified-files-guard`, версия `0.331.0`; production evidence handoff receipt validation now rejects Markdown receipts that omit verified file details. Production readiness gate и full live VPS/staging evidence все еще требуются.
