...
- Latest "Что нового": `2026-08-13-admin-support-read-boundary`, версия `0.686.0`; support conversations/messages ограничены latest top-200 до materialization с хронологическим response order. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
