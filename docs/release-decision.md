...
- Latest "Что нового": `2026-07-02-production-evidence-bundle-generator-release-guard-cleanup`, версия `0.376.0`; production evidence bundle generator release guard now removes its autogenerated empty tmp directory after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
