...
- Latest "Что нового": `2026-08-13-sqlite-telegram-dedup-reconciliation`, версия `0.710.0`; SQLite post-migration repair восстанавливает canonical Telegram notification dedup boundary. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
