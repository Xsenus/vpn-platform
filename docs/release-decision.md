...
- Latest "Что нового": `2026-07-01-production-handoff-package-archive-entry-case-cleanup`, версия `0.343.0`; production evidence handoff package archive entry-case regression now cleans its temporary artifacts. Production readiness gate и full live VPS/staging evidence все еще требуются.
