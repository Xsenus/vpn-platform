...
- Latest "Что нового": `2026-07-02-admin-bootstrap-wrapper-cleanup`, версия `0.386.0`; direct admin bootstrap wrapper now removes default local artifacts after ordinary runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
