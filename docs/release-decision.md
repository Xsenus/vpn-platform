...
- Latest "Что нового": `2026-07-01-production-readiness-summary-latest-release-guard-cleanup`, версия `0.358.0`; production readiness summary latest-release guard now removes its autogenerated default tmp output after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
