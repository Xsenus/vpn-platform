...
- Latest "Что нового": `2026-08-15-admin-operational-label-localization`, версия `0.731.0`; user status, audit actor/category, VPN SSL, access-history, QR и health/support fallback labels проверены desktop/mobile. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence всё ещё требуются.
