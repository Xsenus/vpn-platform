...
- Latest "Что нового": `2026-07-02-vps-production-smoke-generator-release-guard-cleanup`, версия `0.377.0`; VPS production smoke generator release guard now removes its autogenerated empty tmp directory after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
