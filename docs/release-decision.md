...
- Latest "Что нового": `2026-07-01-production-readiness-assertion-ci-regression-default-cleanup`, версия `0.356.0`; production readiness assertion CI regression now removes its autogenerated default output after simple local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
