...
- Browser console smoke: `164/164`; responsive all-screens: `6/6` на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints; local WebP decode и representative screenshots проверены.
...
- Latest "Что нового": `2026-08-11-public-managed-content-load-lifecycle`, версия `0.609.0`; тарифы и аккаунт имеют component-scoped StrictMode claim для managed CMS и отклоняют completion после unmount. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
