...
- Latest "Что нового": `2026-08-14-backend-source-encoding-guard`, версия `0.718.0`; backend C# и generated EF migrations проходят strict UTF-8 without BOM, LF guard и глобальный formatter. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
