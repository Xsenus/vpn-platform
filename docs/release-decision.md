...
- Latest "Что нового": `2026-07-02-admin-vps-bootstrap-release-guard-cleanup`, версия `0.383.0`; Admin VPS bootstrap release guard harnesses now remove their autogenerated reports and empty tmp directory after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
