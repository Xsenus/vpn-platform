...
- Latest "Что нового": `2026-08-13-server-mode-action-boundary`, версия `0.683.0`; server mode-actions защищены revision, EF race возвращает controlled conflict, API client и stale UI fail closed. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
