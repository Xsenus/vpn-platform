...
- Latest "Что нового": `2026-08-05-admin-readiness-link-boundary`, версия `0.524.0`; локальный backend/frontend/SQLite/browser regression и responsive matrix пройдены. Real SMTP и полный live VPS/staging evidence все еще требуются.
- Roadmap progress: `537/557` closed, readiness `96.4%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
