...
- Latest "Что нового": `2026-08-13-admin-finance-read-boundary`, версия `0.687.0`; payments/refunds/order recheck ограничены latest top-300/top-1 до materialization. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
