...
- Browser console smoke: `80/80`; responsive all-screens: `6/6` на 18 viewport-конфигурациях `305x568..2560x1440`; local WebP decode и representative screenshots проверены.
...
- Latest "Что нового": `2026-08-10-admin-managed-configuration-crud-e2e`, версия `0.554.0`; локальный backend/frontend/browser regression, критические admin mutations и полный CRUD управляемой конфигурации на desktop/mobile пройдены. Real SMTP и полный live VPS/staging evidence все еще требуются.
- Roadmap progress: `567/587` closed, readiness `96.6%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
