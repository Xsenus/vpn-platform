...
- Latest "Что нового": `2026-08-14-payment-error-redaction`, версия `0.723.0`; payment/provider exception, status и webhook verifier diagnostics редактируются до application result и persistence. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
