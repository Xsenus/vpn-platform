...
- Latest "Что нового": `2026-07-01-production-handoff-package-archive-nested-entry-guard`, версия `0.335.0`; production evidence handoff package archive validation now has regression coverage for nested ZIP entries. Production readiness gate и full live VPS/staging evidence все еще требуются.
