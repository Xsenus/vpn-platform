...
- Latest "Что нового": `2026-07-02-agent-source-version-reporting-guard`, версия `0.444.0`; DocumentationEncodingTests now verifies that AGENTS.md requires source and date/version reporting for roadmap-derived status. Production readiness gate и full live VPS/staging evidence все еще требуются.
- Roadmap progress: `456/476` closed, readiness `95.8%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
