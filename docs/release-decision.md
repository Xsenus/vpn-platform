...
- Latest "Что нового": `2026-08-13-admin-subscription-access-read-boundary`, версия `0.684.0`; subscription/access lists и user overview ограничены до materialization, access history использует SQL window. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
