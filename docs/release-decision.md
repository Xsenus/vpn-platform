...
- Latest "Что нового": `2026-06-14-api-telegram-webhook`, версия `0.116.0`; API Telegram webhook перенесен в основной backend и читает настройки бота из админки, синхронизированы roadmap, README, final runbook, release decision, changelog и TEST_RESULTS, но live VPS/staging evidence еще требуется.
