...
- Latest "Что нового": `2026-07-01-admin-vps-smoke-preflight-latest-release-guard`, версия `0.314.0`; admin VPS smoke preflight acceptance now rejects stale release reports before real browser smoke can start. Production readiness gate и full live VPS/staging evidence все еще требуются.
