...
- Latest "Что нового": `2026-08-13-node-allocation-selection-boundary`, версия `0.695.0`; node, panel fallback и sandbox allocation выбираются DB-side top-1. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
