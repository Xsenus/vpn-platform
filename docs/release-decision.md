...
- Browser console smoke: `54/54`; responsive all-screens: `6/6`.
...
- Latest "Что нового": `2026-08-09-admin-restored-session-refresh`, версия `0.546.0`; локальный backend/frontend/SQLite/browser regression и responsive matrix пройдены. Real SMTP и полный live VPS/staging evidence все еще требуются.
