...
- Latest "Что нового": `2026-07-02-vpn-live-smoke-generator-release-guard-cleanup`, версия `0.379.0`; VPN live smoke generator release guard now removes its autogenerated empty tmp directory after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
