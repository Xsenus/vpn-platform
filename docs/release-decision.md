...
- Latest "Что нового": `2026-08-12-refund-status-reconciliation`, версия `0.664.0`; YooKassa/Stripe/PayPal поддерживают доказательную сверку отдельного незавершённого возврата, а TBank не использует агрегированный payment status как доказательство partial refund. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
