...
- Latest "Что нового": `2026-07-01-vpn-live-smoke-latest-release-guard`, версия `0.301.0`; VPN live smoke acceptance now rejects stale release evidence before `P0-VPN-*` can be accepted. Production readiness gate и full live VPS/staging evidence все еще требуются.
