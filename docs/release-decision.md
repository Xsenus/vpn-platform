...
- Latest "Что нового": `2026-07-02-production-evidence-bundle-latest-release-guard-cleanup`, версия `0.364.0`; production evidence bundle latest-release guard now removes its autogenerated default tmp output after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
