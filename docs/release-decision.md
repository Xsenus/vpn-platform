...
- Latest "Что нового": `2026-07-02-staging-smoke-latest-release-guard-cleanup`, версия `0.365.0`; staging smoke latest-release guard now removes its autogenerated default tmp output after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
