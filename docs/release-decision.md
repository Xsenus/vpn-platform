...
- Latest "Что нового": `2026-07-02-admin-vps-smoke-release-guard-cleanup`, версия `0.382.0`; Admin VPS smoke release guard harnesses now remove their autogenerated reports and empty tmp directory after local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
