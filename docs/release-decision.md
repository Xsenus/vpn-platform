...
- Browser console smoke: `158/158`; responsive all-screens: `6/6` на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints; local WebP decode и representative screenshots проверены.
...
- Latest "Что нового": `2026-08-11-public-catalog-load-recovery`, версия `0.606.0`; public catalog/provider failures изолированы, error/empty взаимоисключены и обе области восстанавливаются локально без reload. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
