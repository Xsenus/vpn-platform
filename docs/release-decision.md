...
- Browser console smoke: `206/206`; responsive all-screens: `6/6` на 25 viewport-конфигурациях `305x568..2560x1440` с точными парами `N/N+1` для всех CSS-breakpoints; local WebP decode и representative screenshots проверены.
...
- Latest "Что нового": `2026-08-12-cabinet-payment-link-expiry`, версия `0.632.0`; cabinet автоматически скрывает confirmation URL по order expiry в renewal/retry/history без ручного refresh и stale login-time clock. Real VPS/SSH/Ansible, provider/Telegram/SMTP delivery и полный staging/production-like 3x-ui evidence все еще требуются.
