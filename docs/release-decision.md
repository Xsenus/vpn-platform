...
- Latest "Что нового": `2026-08-05-cancelled-subscription-cabinet-boundary`, версия `0.501.0`; локальный backend/frontend/SQLite/browser regression и responsive matrix пройдены. Production readiness gate и full live VPS/staging evidence все еще требуются.
