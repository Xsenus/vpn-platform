...
- Latest "Что нового": `2026-07-02-changelog-external-evidence-open-guard`, версия `0.420.0`; changelog now guards current roadmap progress, validation evidence and production limitations. Production readiness gate и full live VPS/staging evidence все еще требуются.
