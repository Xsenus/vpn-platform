...
- Latest "Что нового": `2026-08-05-vpn-node-state-consistency`, версия `0.482.0`; локальный backend/frontend/SQLite/browser regression и responsive matrix пройдены. Production readiness gate и full live VPS/staging evidence все еще требуются.
- Roadmap progress: `494/514` closed, readiness `96.1%`, `20` remaining, `19` open, `1` in progress and `0` blocked.
