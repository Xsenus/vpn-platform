...
- Latest "Что нового": `2026-07-02-staging-smoke-generator-release-guard-cleanup`, версия `0.366.0`; staging smoke generator release guard now removes its autogenerated empty tmp directory after failed unknown-release local runs. Production readiness gate и full live VPS/staging evidence все еще требуются.
