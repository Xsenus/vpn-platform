...
Playwright поднимает public-web на `http://127.0.0.1:5293` через `frontend/scripts/playwright-webservers.mjs`; тот же helper держит cabinet и admin-panel на стабильных портах для остальных E2E-проектов.
