...
Production readiness assertion result JSON includes `resultJsonPath` and, when Markdown is generated, `resultMarkdownPath`; the validator resolves self-links and requires them to match the actual validated JSON/Markdown files.
...
Production readiness assertion result latest release guard removes its autogenerated `tmp/production-readiness-assertion-result-stale-release-guard.json` output and empty `tmp` directory after a local run.

```powershell
powershell -ExecutionPolicy Bypass -File scripts\test-production-readiness-assertion-result-self-link-guard.ps1
```
...
Production readiness assertion CI step summary removes its autogenerated default output directory and empty `tmp` after ordinary local runs; explicit `-OutputDirectory` and `-WriteJson` preserve artifacts for evidence/debug flows.
...
Production evidence bundle generator release guard removes its autogenerated empty `tmp` directory after a local run.
...
Production evidence manifest release guard removes its autogenerated `tmp/production-evidence-manifest-unknown-release-id` directory and empty `tmp` directory after a local run.
...
Production readiness summary JSON includes `summaryPath` and `jsonSummaryPath`; the validator resolves both fields and requires them to match the actual `-SummaryPath` and `-JsonSummaryPath`.
...
```
Production readiness summary latest release guard removes its autogenerated `tmp/production-readiness-summary-stale-release-guard.md` and `.json` output plus the empty `tmp` directory after a local run.

```powershell
powershell -ExecutionPolicy Bypass -File scripts\test-production-readiness-summary-self-link-guard.ps1
```
...
Production evidence bundle latest release guard removes its autogenerated `tmp/production-evidence-bundle-stale-release-guard` directory and empty `tmp` directory after a local run.
...
Production evidence archive release guard removes its autogenerated `tmp/production-evidence-archive-unknown-release-id` directory and empty `tmp` directory after a local run.
...
Production evidence handoff receipt release guard removes its autogenerated `tmp/production-evidence-handoff-receipt-unknown-release-id` directory and empty `tmp` directory after a local run.
...
Production evidence handoff receipt verified files guard removes its autogenerated `tmp/production-evidence-handoff-receipt-verified-files-guard` bundle directory and empty `tmp` directory after a local run.
...
Production evidence handoff receipt Markdown verified files guard removes its autogenerated `tmp/production-evidence-handoff-receipt-markdown-verified-files-guard` bundle directory and empty `tmp` directory after a local run.
...
Production evidence handoff checklist release guard removes its autogenerated `tmp/production-evidence-handoff-checklist-unknown-release-id` directory and empty `tmp` directory after a local run.
Production evidence handoff package latest release guard removes its autogenerated `tmp/production-evidence-handoff-package-stale-release-guard` package directory and empty `tmp` directory after a local run.
...
```
Production evidence handoff checklist latest release guard removes its autogenerated `tmp/production-evidence-handoff-checklist-stale-release-guard.json` and `.md` output plus the empty `tmp` directory after a local run.
...
Production evidence handoff checklist Markdown gates guard removes its autogenerated `tmp/production-evidence-handoff-checklist-markdown-gates-guard` bundle directory and empty `tmp` directory after a local run.
...
Production evidence handoff package Markdown files guard removes its autogenerated `tmp/production-evidence-handoff-package-markdown-files-guard` bundle directory and empty `tmp` directory after a local run.
...
Production evidence handoff package archive latest release guard removes its autogenerated `tmp/production-evidence-handoff-package-archive-stale-release-guard.zip`, package directory and empty `tmp` directory after a local run.
...
Production evidence handoff package archive flow result latest release guard removes its autogenerated `tmp/production-evidence-handoff-package-archive-flow-result-stale-release-guard.json` output and empty `tmp` directory after a local run.
...
Production evidence handoff package archive CI summary latest release guard removes its autogenerated `tmp/production-evidence-handoff-package-archive-ci-summary-stale-release-guard.json` and `.md` output plus the empty `tmp` directory after a local run.
...
Production evidence handoff package archive CI regression result latest release guard removes its autogenerated `tmp/production-evidence-handoff-package-archive-ci-regression-result-stale-release-guard.json` output and empty `tmp` directory after a local run.
